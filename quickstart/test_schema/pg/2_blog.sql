...
-- Reconnect to devsecdb_test_todo before running following sql
...
CREATE INDEX devsecdb_test_blog_post_name ON public.post(name);
CREATE INDEX devsecdb_test_blog_post_created_ts ON public.post(created_ts);

COMMENT ON COLUMN public.post.name is 'name of the post';
COMMENT ON INDEX devsecdb_test_blog_post_name is 'name index of post';
...
CREATE INDEX devsecdb_test_blog_comment_created_ts ON public.comment(created_ts);
