...
export const CreateWorksheetRequest: MessageFns<CreateWorksheetRequest> = {
  encode(message: CreateWorksheetRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.worksheet !== undefined) {
      Worksheet.encode(message.worksheet, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CreateWorksheetRequest {
...
export const GetWorksheetRequest: MessageFns<GetWorksheetRequest> = {
  encode(message: GetWorksheetRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetWorksheetRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateWorksheetRequest: MessageFns<UpdateWorksheetRequest> = {
  encode(message: UpdateWorksheetRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.worksheet !== undefined) {
      Worksheet.encode(message.worksheet, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateWorksheetRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateWorksheetOrganizerRequest: MessageFns<UpdateWorksheetOrganizerRequest> = {
  encode(message: UpdateWorksheetOrganizerRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.organizer !== undefined) {
      WorksheetOrganizer.encode(message.organizer, writer.uint32(10).fork()).join();
    }
    if (message.updateMask !== undefined) {
      FieldMask.encode(FieldMask.wrap(message.updateMask), writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateWorksheetOrganizerRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WorksheetOrganizer: MessageFns<WorksheetOrganizer> = {
  encode(message: WorksheetOrganizer, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WorksheetOrganizer {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeleteWorksheetRequest: MessageFns<DeleteWorksheetRequest> = {
  encode(message: DeleteWorksheetRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteWorksheetRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SearchWorksheetsRequest: MessageFns<SearchWorksheetsRequest> = {
  encode(message: SearchWorksheetsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.filter !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SearchWorksheetsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SearchWorksheetsResponse: MessageFns<SearchWorksheetsResponse> = {
  encode(message: SearchWorksheetsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.worksheets) {
      Worksheet.encode(v!, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SearchWorksheetsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Worksheet: MessageFns<Worksheet> = {
  encode(message: Worksheet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.project !== "") {
    ...
    if (message.updateTime !== undefined) {
      Timestamp.encode(message.updateTime, writer.uint32(58).fork()).join();
    }
    if (message.content.length !== 0) {
      writer.uint32(66).bytes(message.content);
    }
    if (!message.contentSize.equals(Long.ZERO)) {
      writer.uint32(72).int64(message.contentSize.toString());
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Worksheet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WorksheetServiceDefinition = {
  ...
  fullName: "devsecdb.v1.WorksheetService",
  methods: {
