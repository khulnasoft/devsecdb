...
export const Branch: MessageFns<Branch> = {
  encode(message: Branch, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.schemaMetadata !== undefined) {
      DatabaseMetadata.encode(message.schemaMetadata, writer.uint32(34).fork()).join();
    }
    if (message.baselineSchema !== "") {
      writer.uint32(42).string(message.baselineSchema);
    }
    if (message.baselineSchemaMetadata !== undefined) {
      DatabaseMetadata.encode(message.baselineSchemaMetadata, writer.uint32(50).fork()).join();
    }
    ...
    if (message.createTime !== undefined) {
      Timestamp.encode(message.createTime, writer.uint32(106).fork()).join();
    }
    if (message.updateTime !== undefined) {
      Timestamp.encode(message.updateTime, writer.uint32(114).fork()).join();
    }
    return writer;
  },
...
export const CreateBranchRequest: MessageFns<CreateBranchRequest> = {
  encode(message: CreateBranchRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.branch !== undefined) {
      Branch.encode(message.branch, writer.uint32(18).fork()).join();
    }
    if (message.branchId !== "") {
...
export const UpdateBranchRequest: MessageFns<UpdateBranchRequest> = {
  encode(message: UpdateBranchRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.branch !== undefined) {
      Branch.encode(message.branch, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateBranchRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RebaseBranchRequest: MessageFns<RebaseBranchRequest> = {
  encode(message: RebaseBranchRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RebaseBranchRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RebaseBranchResponse: MessageFns<RebaseBranchResponse> = {
  encode(message: RebaseBranchResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.branch !== undefined) {
      Branch.encode(message.branch, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RebaseBranchResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DiffDatabaseRequest: MessageFns<DiffDatabaseRequest> = {
  encode(message: DiffDatabaseRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.database !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DiffDatabaseRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DiffDatabaseResponse: MessageFns<DiffDatabaseResponse> = {
  encode(message: DiffDatabaseResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.diff !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DiffDatabaseResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BranchServiceDefinition = {
  name: "BranchService",
  fullName: "devsecdb.v1.BranchService",
  methods: {
    getBranch: {
      name: "GetBranch",
      ...
      options: {
        _unknownFields: {
          ...
          800010: [new Uint8Array([15, 98, 98, 46, 98, 114, 97, 110, 99, 104, 101, 115, 46, 103, 101, 116])],
    ...
    listBranches: {
      ...
      options: {
        _unknownFields: {
          ...
          800010: [new Uint8Array([16, 98, 98, 46, 98, 114, 97, 110, 99, 104, 101, 115, 46, 108, 105, 115, 116])],
          800016: [new Uint8Array([1])],
          578365826: [
            new Uint8Array([
              34,
    ...
    createBranch: {
      ...
      options: {
        _unknownFields: {
          ...
          800010: [
            new Uint8Array([18, 98, 98, 46, 98, 114, 97, 110, 99, 104, 101, 115, 46, 99, 114, 101, 97, 116, 101]),
          ],
          800016: [new Uint8Array([1])],
          578365826: [
            new Uint8Array([
