...
export const CreateVCSConnectorRequest: MessageFns<CreateVCSConnectorRequest> = {
  encode(message: CreateVCSConnectorRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.parent !== "") {
      writer.uint32(10).string(message.parent);
    }
    if (message.vcsConnector !== undefined) {
      VCSConnector.encode(message.vcsConnector, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateVCSConnectorRequest {
...
export const GetVCSConnectorRequest: MessageFns<GetVCSConnectorRequest> = {
  encode(message: GetVCSConnectorRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetVCSConnectorRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListVCSConnectorsRequest: MessageFns<ListVCSConnectorsRequest> = {
  encode(message: ListVCSConnectorsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.parent !== "") {
      writer.uint32(10).string(message.parent);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListVCSConnectorsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListVCSConnectorsResponse: MessageFns<ListVCSConnectorsResponse> = {
  encode(message: ListVCSConnectorsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListVCSConnectorsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateVCSConnectorRequest: MessageFns<UpdateVCSConnectorRequest> = {
  encode(message: UpdateVCSConnectorRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.vcsConnector !== undefined) {
      VCSConnector.encode(message.vcsConnector, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateVCSConnectorRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeleteVCSConnectorRequest: MessageFns<DeleteVCSConnectorRequest> = {
  encode(message: DeleteVCSConnectorRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteVCSConnectorRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VCSConnector: MessageFns<VCSConnector> = {
  encode(message: VCSConnector, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.title !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VCSConnector {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VCSConnectorServiceDefinition = {
  ...
  fullName: "devsecdb.v1.VCSConnectorService",
  methods: {
    createVCSConnector: {
