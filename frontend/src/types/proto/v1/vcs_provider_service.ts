...
export interface VCSRepository {
   ...
   * e.g. devsecdb/sample-project
   */
  fullPath: string;
  /**
   * Web url of the repository in vcs provider.
   * e.g. http://gitlab.secdb.khulnasoft.com/devsecdb/sample-project
   */
  webUrl: string;
}
...
export interface VCSProvider {
   ...
   * For example: github.com, gitlab.com, gitlab.secdb.khulnasoft.com.
   */
  url: string;
...
export const CreateVCSProviderRequest: MessageFns<CreateVCSProviderRequest> = {
  encode(message: CreateVCSProviderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.vcsProvider !== undefined) {
      VCSProvider.encode(message.vcsProvider, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateVCSProviderRequest {
...
export const GetVCSProviderRequest: MessageFns<GetVCSProviderRequest> = {
  encode(message: GetVCSProviderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetVCSProviderRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListVCSProvidersRequest: MessageFns<ListVCSProvidersRequest> = {
  encode(message: ListVCSProvidersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListVCSProvidersRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListVCSProvidersResponse: MessageFns<ListVCSProvidersResponse> = {
  encode(message: ListVCSProvidersResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.vcsProviders) {
      VCSProvider.encode(v!, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListVCSProvidersResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateVCSProviderRequest: MessageFns<UpdateVCSProviderRequest> = {
  encode(message: UpdateVCSProviderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.vcsProvider !== undefined) {
      VCSProvider.encode(message.vcsProvider, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateVCSProviderRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeleteVCSProviderRequest: MessageFns<DeleteVCSProviderRequest> = {
  encode(message: DeleteVCSProviderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteVCSProviderRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SearchVCSProviderRepositoriesRequest: MessageFns<SearchVCSProviderRepositoriesRequest> = {
  encode(message: SearchVCSProviderRepositoriesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SearchVCSProviderRepositoriesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VCSRepository: MessageFns<VCSRepository> = {
  encode(message: VCSRepository, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VCSRepository {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SearchVCSProviderRepositoriesResponse: MessageFns<SearchVCSProviderRepositoriesResponse> = {
  encode(message: SearchVCSProviderRepositoriesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.repositories) {
      VCSRepository.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SearchVCSProviderRepositoriesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListVCSConnectorsInProviderRequest: MessageFns<ListVCSConnectorsInProviderRequest> = {
  encode(message: ListVCSConnectorsInProviderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListVCSConnectorsInProviderRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListVCSConnectorsInProviderResponse: MessageFns<ListVCSConnectorsInProviderResponse> = {
  encode(message: ListVCSConnectorsInProviderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.vcsConnectors) {
      VCSConnector.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListVCSConnectorsInProviderResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VCSProvider: MessageFns<VCSProvider> = {
  encode(message: VCSProvider, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.title !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VCSProvider {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VCSProviderServiceDefinition = {
  ...
  fullName: "devsecdb.v1.VCSProviderService",
  methods: {
    getVCSProvider: {
      name: "GetVCSProvider",
