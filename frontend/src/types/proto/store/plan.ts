...
export interface PlanConfig_SpecReleaseSource {
...
export const PlanConfig_Step: MessageFns<PlanConfig_Step> = {
  encode(message: PlanConfig_Step, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(18).string(message.title);
    }
    for (const v of message.specs) {
      PlanConfig_Spec.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PlanConfig_Step {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PlanConfig_Spec: MessageFns<PlanConfig_Spec> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PlanConfig_Spec {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.specReleaseSource = PlanConfig_SpecReleaseSource.decode(reader, reader.uint32());
          continue;
        case 1:
          if (tag !== 10) {
            break;
...
export const PlanConfig_CreateDatabaseConfig: MessageFns<PlanConfig_CreateDatabaseConfig> = {
  encode(message: PlanConfig_CreateDatabaseConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.target !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PlanConfig_CreateDatabaseConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PlanConfig_ChangeDatabaseConfig: MessageFns<PlanConfig_ChangeDatabaseConfig> = {
  encode(message: PlanConfig_ChangeDatabaseConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.target !== "") {
      writer.uint32(10).string(message.target);
    }
    if (message.sheet !== "") {
    ...
    if (message.preUpdateBackupDetail !== undefined) {
      PreUpdateBackupDetail.encode(message.preUpdateBackupDetail, writer.uint32(66).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PlanConfig_ChangeDatabaseConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PlanConfig_ChangeDatabaseConfig_GhostFlagsEntry: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PlanConfig_ChangeDatabaseConfig_GhostFlagsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PlanConfig_ExportDataConfig: MessageFns<PlanConfig_ExportDataConfig> = {
  encode(message: PlanConfig_ExportDataConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.target !== "") {
      writer.uint32(10).string(message.target);
    }
    if (message.sheet !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PlanConfig_ExportDataConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PlanConfig_ReleaseSource: MessageFns<PlanConfig_ReleaseSource> = {
  encode(message: PlanConfig_ReleaseSource, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.release !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PlanConfig_ReleaseSource {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePlanConfig_ReleaseSource();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): PlanConfig_ReleaseSource {
    return { release: isSet(object.release) ? globalThis.String(object.release) : "" };
  },

  toJSON(message: PlanConfig_ReleaseSource): unknown {
    const obj: any = {};
    if (message.release !== "") {
  ...
  create(base?: DeepPartial<PlanConfig_ReleaseSource>): PlanConfig_ReleaseSource {
    return PlanConfig_ReleaseSource.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PlanConfig_ReleaseSource>): PlanConfig_ReleaseSource {
    const message = createBasePlanConfig_ReleaseSource();
...
function createBasePlanConfig_SpecReleaseSource(): PlanConfig_SpecReleaseSource {
  return { file: "" };
}

export const PlanConfig_SpecReleaseSource: MessageFns<PlanConfig_SpecReleaseSource> = {
  encode(message: PlanConfig_SpecReleaseSource, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.file !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PlanConfig_SpecReleaseSource {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): PlanConfig_SpecReleaseSource {
    return { file: isSet(object.file) ? globalThis.String(object.file) : "" };
  },

  toJSON(message: PlanConfig_SpecReleaseSource): unknown {
    const obj: any = {};
    if (message.file !== "") {
  ...
  create(base?: DeepPartial<PlanConfig_SpecReleaseSource>): PlanConfig_SpecReleaseSource {
    return PlanConfig_SpecReleaseSource.fromPartial(base ?? {});
  },
