...
export const MFAConfig: MessageFns<MFAConfig> = {
  encode(message: MFAConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MFAConfig {
