...
export const projectWebhookV1TypeItemList = (): ProjectWebhookV1TypeItem[] => {
  return [
    ...
    },
    {
      ...
      urlPrefix:
        "https://secdb.khulnasoft.com/docs/change-database/webhook/?source=console#custom",
      urlPlaceholder: "https://example.com/api/webhook/...",
      docUrl:
        "https://www.secdb.khulnasoft.com/docs/change-database/webhook/?source=console#custom",
      supportDirectMessage: false,
    },
  ];
};
