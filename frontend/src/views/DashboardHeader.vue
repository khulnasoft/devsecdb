...
import { defineAction, useRegisterActions } from "@devsecdb/vue-kbar";
import { useKBarHandler } from "@devsecdb/vue-kbar";
...
import DevsecdbLogo from "../components/DevsecdbLogo.vue";
...
const handleWantHelp = () => {
  if (locale.value === "zh-CN") {
    ...
    window.open("https://www.secdb.khulnasoft.com/docs/faq#how-to-reach-us", "_blank");
  }
};
</script>
