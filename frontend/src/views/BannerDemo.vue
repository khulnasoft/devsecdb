      ...
      <div class="flex items-center justify-between flex-wrap">
        <div class="w-0 flex-1 flex items-center">
          <p class="flex font-medium text-white items-center truncate">
            📆
            <a
              href="https://cal.com/devsecdb/product-walkthrough"
              target="_blank"
        ...
        >
          <a
            href="https://secdb.khulnasoft.com/docs/get-started/install/deploy-with-docker?source=demo"
            target="_blank"
          ...
          <a
            href="https://hub.secdb.khulnasoft.com/workspace?source=demo"
            target="_blank"
            class="flex items-center justify-center pl-4 pr-2 py-1 border border-transparent rounded-sm text-base font-medium text-accent bg-white hover:bg-indigo-50"
          >
            {{ $t("banner.cloud") }}
