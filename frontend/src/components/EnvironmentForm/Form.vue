    ...
    <div class="flex flex-col gap-y-6">
      ...
      <div v-if="features.includes('TIER')" class="flex flex-col gap-y-2">
        ...
        <p class="text-sm text-gray-600">
          ...
          <a
            ...
            href="https://www.secdb.khulnasoft.com/docs/administration/environment-policy/overview/?source=console#environment-tier"
            target="_blank"
            >{{ $t("common.learn-more")
      ...
      >
        ...
        <div class="textinfolabel">
          ...
          <a
            class="inline-flex items-center text-blue-600 ml-1 hover:underline"
            href="https://www.secdb.khulnasoft.com/docs/administration/environment-policy/rollout-policy"
            target="_blank"
            >{{ $t("common.learn-more")
            }}<heroicons-outline:external-link class="w-4 h-4"
          /></a>
