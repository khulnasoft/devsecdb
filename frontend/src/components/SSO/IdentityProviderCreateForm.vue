    ...
    <div class="w-full flex flex-col justify-start items-start space-y-3 mt-3">
      <div class="w-full flex flex-col justify-start items-start">
        ...
        <p class="textinfolabel">
          ...
          <a
            href="https://www.secdb.khulnasoft.com/docs/administration/sso/oauth2#user-information-field-mapping?source=console"
            class="normal-link text-sm inline-flex flex-row items-center"
            target="_blank"
          >
            {{ $t("common.learn-more") }}
...
const userDocLink = computed(() => {
  if (state.type === IdentityProviderType.OAUTH2) {
    return "https://www.secdb.khulnasoft.com/docs/administration/sso/oauth2?source=console";
  } else if (state.type === IdentityProviderType.OIDC) {
    return "https://www.secdb.khulnasoft.com/docs/administration/sso/oidc?source=console";
  } else if (state.type === IdentityProviderType.LDAP) {
    return "https://www.secdb.khulnasoft.com/docs/administration/sso/ldap?source=console";
  }
  return "";
});
