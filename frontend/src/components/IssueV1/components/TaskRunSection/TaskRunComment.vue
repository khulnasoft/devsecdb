  ...
  if (
    ...
    if (comment.value.includes("version")) {
      return {
        ...
        link: "https://www.secdb.khulnasoft.com/docs/change-database/troubleshoot/?source=console#duplicate-version",
      };
    } else if (isPostgresFamily(db.instanceResource.engine)) {
      return {
        title: t("common.troubleshoot"),
        link: "https://www.secdb.khulnasoft.com/docs/change-database/troubleshoot/?source=console#postgresql",
      };
    }
  }
  return {
