    ...
    <div v-else class="sm:col-span-3 sm:col-start-1">
      ...
      >
        <div v-if="!hideAdvancedFeatures" class="mb-4">
          ...
          <LearnMoreLink
            url="http://www.secdb.khulnasoft.com/docs/get-started/instance/#use-external-secret-manager"
            class="text-sm"
          />
        </div>
        <div
        ...
        >
          ...
          <div v-if="!hideAdvancedFeatures" class="flex space-x-2 text-sm">
            ...
            <LearnMoreLink
              url="https://www.secdb.khulnasoft.com/docs/get-started/instance/#use-secret-manager?source=console"
              class="ml-1 text-sm"
            />
            <FeatureBadge feature="bb.feature.external-secret-manager" />
          </div>
