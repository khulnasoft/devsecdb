  ...
  <div class="mt-2 textinfolabel">
    <i18n-t keypath="repository.gitops-description-file-path">
      ...
      <template #naming>
        <a
          class="normal-link"
          href="https://www.secdb.khulnasoft.com/docs/vcs-integration/create-migration-files/?source=console"
          target="_blank"
        >
    ...
    <span>&nbsp;</span>
    <TroubleshootLink
      url="https://www.secdb.khulnasoft.com/docs/vcs-integration/troubleshoot/?source=console"
    />
  </div>
  <RepositoryForm
    class="mt-4"
