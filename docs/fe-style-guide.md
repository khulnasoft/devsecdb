...
See [BBAlert](https://github.com/khulnasoft/devsecdb/blob/main/frontend/src/bbkit/BBAlert.vue) as an example of this pattern.
...
See [the configuration file](https://github.com/khulnasoft/devsecdb/blob/main/frontend/.eslintrc.js) to learn more about the rules.
