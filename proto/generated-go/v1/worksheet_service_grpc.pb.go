...
const (
	WorksheetService_CreateWorksheet_FullMethodName          = "/devsecdb.v1.WorksheetService/CreateWorksheet"
	WorksheetService_GetWorksheet_FullMethodName             = "/devsecdb.v1.WorksheetService/GetWorksheet"
	WorksheetService_SearchWorksheets_FullMethodName         = "/devsecdb.v1.WorksheetService/SearchWorksheets"
	WorksheetService_UpdateWorksheet_FullMethodName          = "/devsecdb.v1.WorksheetService/UpdateWorksheet"
	WorksheetService_UpdateWorksheetOrganizer_FullMethodName = "/devsecdb.v1.WorksheetService/UpdateWorksheetOrganizer"
	WorksheetService_DeleteWorksheet_FullMethodName          = "/devsecdb.v1.WorksheetService/DeleteWorksheet"
)
...
func RegisterWorksheetServiceServer(s grpc.ServiceRegistrar, srv WorksheetServiceServer) {
	// If the following call pancis, it indicates UnimplementedWorksheetServiceServer was
...
var WorksheetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devsecdb.v1.WorksheetService",
