...
const (
	OrgPolicyService_GetPolicy_FullMethodName    = "/devsecdb.v1.OrgPolicyService/GetPolicy"
	OrgPolicyService_ListPolicies_FullMethodName = "/devsecdb.v1.OrgPolicyService/ListPolicies"
	OrgPolicyService_CreatePolicy_FullMethodName = "/devsecdb.v1.OrgPolicyService/CreatePolicy"
	OrgPolicyService_UpdatePolicy_FullMethodName = "/devsecdb.v1.OrgPolicyService/UpdatePolicy"
	OrgPolicyService_DeletePolicy_FullMethodName = "/devsecdb.v1.OrgPolicyService/DeletePolicy"
)
...
func RegisterOrgPolicyServiceServer(s grpc.ServiceRegistrar, srv OrgPolicyServiceServer) {
	// If the following call pancis, it indicates UnimplementedOrgPolicyServiceServer was
...
var OrgPolicyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devsecdb.v1.OrgPolicyService",
