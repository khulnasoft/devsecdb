...
const (
	IssueService_GetIssue_FullMethodName                = "/devsecdb.v1.IssueService/GetIssue"
	IssueService_CreateIssue_FullMethodName             = "/devsecdb.v1.IssueService/CreateIssue"
	IssueService_ListIssues_FullMethodName              = "/devsecdb.v1.IssueService/ListIssues"
	IssueService_SearchIssues_FullMethodName            = "/devsecdb.v1.IssueService/SearchIssues"
	IssueService_UpdateIssue_FullMethodName             = "/devsecdb.v1.IssueService/UpdateIssue"
	IssueService_ListIssueComments_FullMethodName       = "/devsecdb.v1.IssueService/ListIssueComments"
	IssueService_CreateIssueComment_FullMethodName      = "/devsecdb.v1.IssueService/CreateIssueComment"
	IssueService_UpdateIssueComment_FullMethodName      = "/devsecdb.v1.IssueService/UpdateIssueComment"
	IssueService_BatchUpdateIssuesStatus_FullMethodName = "/devsecdb.v1.IssueService/BatchUpdateIssuesStatus"
	IssueService_ApproveIssue_FullMethodName            = "/devsecdb.v1.IssueService/ApproveIssue"
	IssueService_RejectIssue_FullMethodName             = "/devsecdb.v1.IssueService/RejectIssue"
	IssueService_RequestIssue_FullMethodName            = "/devsecdb.v1.IssueService/RequestIssue"
)
...
func (c *issueServiceClient) ListIssueComments(ctx context.Context, in *ListIssueCommentsRequest, opts ...grpc.CallOption) (*ListIssueCommentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, IssueService_ListIssueComments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *issueServiceClient) BatchUpdateIssuesStatus(ctx context.Context, in *BatchUpdateIssuesStatusRequest, opts ...grpc.CallOption) (*BatchUpdateIssuesStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, IssueService_BatchUpdateIssuesStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *issueServiceClient) ApproveIssue(ctx context.Context, in *ApproveIssueRequest, opts ...grpc.CallOption) (*Issue, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Issue)
	err := c.cc.Invoke(ctx, IssueService_ApproveIssue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *issueServiceClient) RejectIssue(ctx context.Context, in *RejectIssueRequest, opts ...grpc.CallOption) (*Issue, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Issue)
	err := c.cc.Invoke(ctx, IssueService_RejectIssue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *issueServiceClient) RequestIssue(ctx context.Context, in *RequestIssueRequest, opts ...grpc.CallOption) (*Issue, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Issue)
	err := c.cc.Invoke(ctx, IssueService_RequestIssue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var IssueService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devsecdb.v1.IssueService",
