...
const (
	InstanceRoleService_GetInstanceRole_FullMethodName   = "/devsecdb.v1.InstanceRoleService/GetInstanceRole"
	InstanceRoleService_ListInstanceRoles_FullMethodName = "/devsecdb.v1.InstanceRoleService/ListInstanceRoles"
)
...
func RegisterInstanceRoleServiceServer(s grpc.ServiceRegistrar, srv InstanceRoleServiceServer) {
	// If the following call pancis, it indicates UnimplementedInstanceRoleServiceServer was
...
var InstanceRoleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devsecdb.v1.InstanceRoleService",
