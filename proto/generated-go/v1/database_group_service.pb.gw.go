...
func RegisterDatabaseGroupServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DatabaseGroupServiceServer) error {
	mux.Handle(http.MethodGet, pattern_DatabaseGroupService_ListDatabaseGroups_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.DatabaseGroupService/ListDatabaseGroups", runtime.WithHTTPPathPattern("/v1/{parent=projects/*}/databaseGroups"))
		if err != nil {
	...
	mux.Handle(http.MethodGet, pattern_DatabaseGroupService_GetDatabaseGroup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.DatabaseGroupService/GetDatabaseGroup", runtime.WithHTTPPathPattern("/v1/{name=projects/*/databaseGroups/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPost, pattern_DatabaseGroupService_CreateDatabaseGroup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.DatabaseGroupService/CreateDatabaseGroup", runtime.WithHTTPPathPattern("/v1/{parent=projects/*}/databaseGroups"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPatch, pattern_DatabaseGroupService_UpdateDatabaseGroup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.DatabaseGroupService/UpdateDatabaseGroup", runtime.WithHTTPPathPattern("/v1/{database_group.name=projects/*/databaseGroups/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodDelete, pattern_DatabaseGroupService_DeleteDatabaseGroup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.DatabaseGroupService/DeleteDatabaseGroup", runtime.WithHTTPPathPattern("/v1/{name=projects/*/databaseGroups/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterDatabaseGroupServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DatabaseGroupServiceClient) error {
	mux.Handle(http.MethodGet, pattern_DatabaseGroupService_ListDatabaseGroups_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.DatabaseGroupService/ListDatabaseGroups", runtime.WithHTTPPathPattern("/v1/{parent=projects/*}/databaseGroups"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodGet, pattern_DatabaseGroupService_GetDatabaseGroup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.DatabaseGroupService/GetDatabaseGroup", runtime.WithHTTPPathPattern("/v1/{name=projects/*/databaseGroups/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPost, pattern_DatabaseGroupService_CreateDatabaseGroup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.DatabaseGroupService/CreateDatabaseGroup", runtime.WithHTTPPathPattern("/v1/{parent=projects/*}/databaseGroups"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodPatch, pattern_DatabaseGroupService_UpdateDatabaseGroup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.DatabaseGroupService/UpdateDatabaseGroup", runtime.WithHTTPPathPattern("/v1/{database_group.name=projects/*/databaseGroups/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle(http.MethodDelete, pattern_DatabaseGroupService_DeleteDatabaseGroup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.DatabaseGroupService/DeleteDatabaseGroup", runtime.WithHTTPPathPattern("/v1/{name=projects/*/databaseGroups/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
