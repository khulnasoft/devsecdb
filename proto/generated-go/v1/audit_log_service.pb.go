...
type SearchAuditLogsRequest struct {
	...
	// For example:
	//   - filter = "method == '/devsecdb.v1.SQLService/Query'"
	//   - filter = "method == '/devsecdb.v1.SQLService/Query' && severity == 'ERROR'"
	//   - filter = "method == '/devsecdb.v1.SQLService/Query' && severity == 'ERROR' && user == 'users/bb@secdb.khulnasoft.com'"
	//   - filter = "method == '/devsecdb.v1.SQLService/Query' && severity == 'ERROR' && create_time <= '2021-01-01T00:00:00Z' && create_time >= '2020-01-01T00:00:00Z'"
...
type AuditLog struct {
	...
	// e.g. `/devsecdb.v1.SQLService/Query`, `bb.project.repository.push`
	Method   string            `protobuf:"bytes,4,opt,name=method,proto3" json:"method,omitempty"`
	Severity AuditLog_Severity `protobuf:"varint,5,opt,name=severity,proto3,enum=devsecdb.v1.AuditLog_Severity" json:"severity,omitempty"`
...
var file_v1_audit_log_service_proto_goTypes = []any{
	(AuditLog_Severity)(0),          // 0: devsecdb.v1.AuditLog.Severity
	(*SearchAuditLogsRequest)(nil),  // 1: devsecdb.v1.SearchAuditLogsRequest
	(*SearchAuditLogsResponse)(nil), // 2: devsecdb.v1.SearchAuditLogsResponse
	(*ExportAuditLogsRequest)(nil),  // 3: devsecdb.v1.ExportAuditLogsRequest
	(*ExportAuditLogsResponse)(nil), // 4: devsecdb.v1.ExportAuditLogsResponse
	(*AuditLog)(nil),                // 5: devsecdb.v1.AuditLog
	(*AuditData)(nil),               // 6: devsecdb.v1.AuditData
	(*RequestMetadata)(nil),         // 7: devsecdb.v1.RequestMetadata
	(ExportFormat)(0),               // 8: devsecdb.v1.ExportFormat
	(*timestamppb.Timestamp)(nil),   // 9: google.protobuf.Timestamp
	(*status.Status)(nil),           // 10: google.rpc.Status
	(*anypb.Any)(nil),               // 11: google.protobuf.Any
	(*PolicyDelta)(nil),             // 12: devsecdb.v1.PolicyDelta
}
var file_v1_audit_log_service_proto_depIdxs = []int32{
	5,  // 0: devsecdb.v1.SearchAuditLogsResponse.audit_logs:type_name -> devsecdb.v1.AuditLog
	8,  // 1: devsecdb.v1.ExportAuditLogsRequest.format:type_name -> devsecdb.v1.ExportFormat
	9,  // 2: devsecdb.v1.AuditLog.create_time:type_name -> google.protobuf.Timestamp
	0,  // 3: devsecdb.v1.AuditLog.severity:type_name -> devsecdb.v1.AuditLog.Severity
	10, // 4: devsecdb.v1.AuditLog.status:type_name -> google.rpc.Status
	11, // 5: devsecdb.v1.AuditLog.service_data:type_name -> google.protobuf.Any
	7,  // 6: devsecdb.v1.AuditLog.request_metadata:type_name -> devsecdb.v1.RequestMetadata
	12, // 7: devsecdb.v1.AuditData.policy_delta:type_name -> devsecdb.v1.PolicyDelta
	1,  // 8: devsecdb.v1.AuditLogService.SearchAuditLogs:input_type -> devsecdb.v1.SearchAuditLogsRequest
	3,  // 9: devsecdb.v1.AuditLogService.ExportAuditLogs:input_type -> devsecdb.v1.ExportAuditLogsRequest
	2,  // 10: devsecdb.v1.AuditLogService.SearchAuditLogs:output_type -> devsecdb.v1.SearchAuditLogsResponse
	4,  // 11: devsecdb.v1.AuditLogService.ExportAuditLogs:output_type -> devsecdb.v1.ExportAuditLogsResponse
