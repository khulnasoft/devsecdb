...
type Anomaly struct {
	...
	Type Anomaly_AnomalyType `protobuf:"varint,2,opt,name=type,proto3,enum=devsecdb.v1.Anomaly_AnomalyType" json:"type,omitempty"`
	// severity is the severity of the anomaly.
	Severity Anomaly_AnomalySeverity `protobuf:"varint,3,opt,name=severity,proto3,enum=devsecdb.v1.Anomaly_AnomalySeverity" json:"severity,omitempty"`
...
var file_v1_anomaly_service_proto_goTypes = []any{
	(Anomaly_AnomalyType)(0),                  // 0: devsecdb.v1.Anomaly.AnomalyType
	(Anomaly_AnomalySeverity)(0),              // 1: devsecdb.v1.Anomaly.AnomalySeverity
	(*SearchAnomaliesRequest)(nil),            // 2: devsecdb.v1.SearchAnomaliesRequest
	(*SearchAnomaliesResponse)(nil),           // 3: devsecdb.v1.SearchAnomaliesResponse
	(*Anomaly)(nil),                           // 4: devsecdb.v1.Anomaly
	(*Anomaly_InstanceConnectionDetail)(nil),  // 5: devsecdb.v1.Anomaly.InstanceConnectionDetail
	(*Anomaly_DatabaseConnectionDetail)(nil),  // 6: devsecdb.v1.Anomaly.DatabaseConnectionDetail
	(*Anomaly_DatabaseSchemaDriftDetail)(nil), // 7: devsecdb.v1.Anomaly.DatabaseSchemaDriftDetail
	(*timestamppb.Timestamp)(nil),             // 8: google.protobuf.Timestamp
}
var file_v1_anomaly_service_proto_depIdxs = []int32{
	4, // 0: devsecdb.v1.SearchAnomaliesResponse.anomalies:type_name -> devsecdb.v1.Anomaly
	0, // 1: devsecdb.v1.Anomaly.type:type_name -> devsecdb.v1.Anomaly.AnomalyType
	1, // 2: devsecdb.v1.Anomaly.severity:type_name -> devsecdb.v1.Anomaly.AnomalySeverity
	5, // 3: devsecdb.v1.Anomaly.instance_connection_detail:type_name -> devsecdb.v1.Anomaly.InstanceConnectionDetail
	6, // 4: devsecdb.v1.Anomaly.database_connection_detail:type_name -> devsecdb.v1.Anomaly.DatabaseConnectionDetail
	7, // 5: devsecdb.v1.Anomaly.database_schema_drift_detail:type_name -> devsecdb.v1.Anomaly.DatabaseSchemaDriftDetail
	8, // 6: devsecdb.v1.Anomaly.create_time:type_name -> google.protobuf.Timestamp
	8, // 7: devsecdb.v1.Anomaly.update_time:type_name -> google.protobuf.Timestamp
	2, // 8: devsecdb.v1.AnomalyService.SearchAnomalies:input_type -> devsecdb.v1.SearchAnomaliesRequest
	3, // 9: devsecdb.v1.AnomalyService.SearchAnomalies:output_type -> devsecdb.v1.SearchAnomaliesResponse
