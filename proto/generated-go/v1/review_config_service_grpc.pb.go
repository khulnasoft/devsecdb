...
const (
	ReviewConfigService_CreateReviewConfig_FullMethodName = "/devsecdb.v1.ReviewConfigService/CreateReviewConfig"
	ReviewConfigService_ListReviewConfigs_FullMethodName  = "/devsecdb.v1.ReviewConfigService/ListReviewConfigs"
	ReviewConfigService_GetReviewConfig_FullMethodName    = "/devsecdb.v1.ReviewConfigService/GetReviewConfig"
	ReviewConfigService_UpdateReviewConfig_FullMethodName = "/devsecdb.v1.ReviewConfigService/UpdateReviewConfig"
	ReviewConfigService_DeleteReviewConfig_FullMethodName = "/devsecdb.v1.ReviewConfigService/DeleteReviewConfig"
)
...
func RegisterReviewConfigServiceServer(s grpc.ServiceRegistrar, srv ReviewConfigServiceServer) {
	// If the following call pancis, it indicates UnimplementedReviewConfigServiceServer was
...
var ReviewConfigService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devsecdb.v1.ReviewConfigService",
