...
const (
	VCSConnectorService_CreateVCSConnector_FullMethodName = "/devsecdb.v1.VCSConnectorService/CreateVCSConnector"
	VCSConnectorService_GetVCSConnector_FullMethodName    = "/devsecdb.v1.VCSConnectorService/GetVCSConnector"
	VCSConnectorService_ListVCSConnectors_FullMethodName  = "/devsecdb.v1.VCSConnectorService/ListVCSConnectors"
	VCSConnectorService_UpdateVCSConnector_FullMethodName = "/devsecdb.v1.VCSConnectorService/UpdateVCSConnector"
	VCSConnectorService_DeleteVCSConnector_FullMethodName = "/devsecdb.v1.VCSConnectorService/DeleteVCSConnector"
)
...
func (c *vCSConnectorServiceClient) CreateVCSConnector(ctx context.Context, in *CreateVCSConnectorRequest, opts ...grpc.CallOption) (*VCSConnector, error) {
	...
	err := c.cc.Invoke(ctx, VCSConnectorService_CreateVCSConnector_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vCSConnectorServiceClient) GetVCSConnector(ctx context.Context, in *GetVCSConnectorRequest, opts ...grpc.CallOption) (*VCSConnector, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VCSConnector)
	err := c.cc.Invoke(ctx, VCSConnectorService_GetVCSConnector_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vCSConnectorServiceClient) ListVCSConnectors(ctx context.Context, in *ListVCSConnectorsRequest, opts ...grpc.CallOption) (*ListVCSConnectorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, VCSConnectorService_ListVCSConnectors_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vCSConnectorServiceClient) UpdateVCSConnector(ctx context.Context, in *UpdateVCSConnectorRequest, opts ...grpc.CallOption) (*VCSConnector, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VCSConnector)
	err := c.cc.Invoke(ctx, VCSConnectorService_UpdateVCSConnector_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vCSConnectorServiceClient) DeleteVCSConnector(ctx context.Context, in *DeleteVCSConnectorRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, VCSConnectorService_DeleteVCSConnector_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedVCSConnectorServiceServer must be embedded to have
...
func (UnimplementedVCSConnectorServiceServer) testEmbeddedByValue()                             {}
...
func RegisterVCSConnectorServiceServer(s grpc.ServiceRegistrar, srv VCSConnectorServiceServer) {
	// If the following call pancis, it indicates UnimplementedVCSConnectorServiceServer was
...
var VCSConnectorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devsecdb.v1.VCSConnectorService",
