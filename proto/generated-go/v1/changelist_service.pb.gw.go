...
func RegisterChangelistServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ChangelistServiceServer) error {
	...
	mux.Handle("POST", pattern_ChangelistService_CreateChangelist_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.ChangelistService/CreateChangelist", runtime.WithHTTPPathPattern("/v1/{parent=projects/*}/changelists"))
		if err != nil {
	...
	mux.Handle("GET", pattern_ChangelistService_GetChangelist_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.ChangelistService/GetChangelist", runtime.WithHTTPPathPattern("/v1/{name=projects/*/changelists/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ChangelistService_ListChangelists_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.ChangelistService/ListChangelists", runtime.WithHTTPPathPattern("/v1/{parent=projects/*}/changelists"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_ChangelistService_UpdateChangelist_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.ChangelistService/UpdateChangelist", runtime.WithHTTPPathPattern("/v1/{changelist.name=projects/*/changelists/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_ChangelistService_DeleteChangelist_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.ChangelistService/DeleteChangelist", runtime.WithHTTPPathPattern("/v1/{name=projects/*/changelists/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterChangelistServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ChangelistServiceClient) error {
	...
	mux.Handle("POST", pattern_ChangelistService_CreateChangelist_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.ChangelistService/CreateChangelist", runtime.WithHTTPPathPattern("/v1/{parent=projects/*}/changelists"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ChangelistService_GetChangelist_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.ChangelistService/GetChangelist", runtime.WithHTTPPathPattern("/v1/{name=projects/*/changelists/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ChangelistService_ListChangelists_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.ChangelistService/ListChangelists", runtime.WithHTTPPathPattern("/v1/{parent=projects/*}/changelists"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_ChangelistService_UpdateChangelist_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.ChangelistService/UpdateChangelist", runtime.WithHTTPPathPattern("/v1/{changelist.name=projects/*/changelists/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_ChangelistService_DeleteChangelist_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.ChangelistService/DeleteChangelist", runtime.WithHTTPPathPattern("/v1/{name=projects/*/changelists/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
