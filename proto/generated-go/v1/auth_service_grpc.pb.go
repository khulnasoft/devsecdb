...
const (
	AuthService_GetUser_FullMethodName      = "/devsecdb.v1.AuthService/GetUser"
	AuthService_ListUsers_FullMethodName    = "/devsecdb.v1.AuthService/ListUsers"
	AuthService_CreateUser_FullMethodName   = "/devsecdb.v1.AuthService/CreateUser"
	AuthService_UpdateUser_FullMethodName   = "/devsecdb.v1.AuthService/UpdateUser"
	AuthService_DeleteUser_FullMethodName   = "/devsecdb.v1.AuthService/DeleteUser"
	AuthService_UndeleteUser_FullMethodName = "/devsecdb.v1.AuthService/UndeleteUser"
	AuthService_Login_FullMethodName        = "/devsecdb.v1.AuthService/Login"
	AuthService_Logout_FullMethodName       = "/devsecdb.v1.AuthService/Logout"
)
...
func (c *authServiceClient) UndeleteUser(ctx context.Context, in *UndeleteUserRequest, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
	err := c.cc.Invoke(ctx, AuthService_UndeleteUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devsecdb.v1.AuthService",
