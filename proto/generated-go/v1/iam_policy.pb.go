...
type BindingDelta struct {
	...
	Action BindingDelta_Action `protobuf:"varint,1,opt,name=action,proto3,enum=devsecdb.v1.BindingDelta_Action" json:"action,omitempty"`
...
var file_v1_iam_policy_proto_goTypes = []any{
	(BindingDelta_Action)(0),    // 0: devsecdb.v1.BindingDelta.Action
	(*GetIamPolicyRequest)(nil), // 1: devsecdb.v1.GetIamPolicyRequest
	(*SetIamPolicyRequest)(nil), // 2: devsecdb.v1.SetIamPolicyRequest
	(*IamPolicy)(nil),           // 3: devsecdb.v1.IamPolicy
	(*Binding)(nil),             // 4: devsecdb.v1.Binding
	(*PolicyDelta)(nil),         // 5: devsecdb.v1.PolicyDelta
	(*BindingDelta)(nil),        // 6: devsecdb.v1.BindingDelta
...
var file_v1_iam_policy_proto_depIdxs = []int32{
	3, // 0: devsecdb.v1.SetIamPolicyRequest.policy:type_name -> devsecdb.v1.IamPolicy
	4, // 1: devsecdb.v1.IamPolicy.bindings:type_name -> devsecdb.v1.Binding
	7, // 2: devsecdb.v1.Binding.condition:type_name -> google.type.Expr
	8, // 3: devsecdb.v1.Binding.parsed_expr:type_name -> google.api.expr.v1alpha1.Expr
	6, // 4: devsecdb.v1.PolicyDelta.binding_deltas:type_name -> devsecdb.v1.BindingDelta
	0, // 5: devsecdb.v1.BindingDelta.action:type_name -> devsecdb.v1.BindingDelta.Action
	7, // 6: devsecdb.v1.BindingDelta.condition:type_name -> google.type.Expr
