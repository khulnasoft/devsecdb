...
const (
	InstanceService_GetInstance_FullMethodName        = "/devsecdb.v1.InstanceService/GetInstance"
	InstanceService_ListInstances_FullMethodName      = "/devsecdb.v1.InstanceService/ListInstances"
	InstanceService_CreateInstance_FullMethodName     = "/devsecdb.v1.InstanceService/CreateInstance"
	InstanceService_UpdateInstance_FullMethodName     = "/devsecdb.v1.InstanceService/UpdateInstance"
	InstanceService_DeleteInstance_FullMethodName     = "/devsecdb.v1.InstanceService/DeleteInstance"
	InstanceService_UndeleteInstance_FullMethodName   = "/devsecdb.v1.InstanceService/UndeleteInstance"
	InstanceService_SyncInstance_FullMethodName       = "/devsecdb.v1.InstanceService/SyncInstance"
	InstanceService_BatchSyncInstances_FullMethodName = "/devsecdb.v1.InstanceService/BatchSyncInstances"
	InstanceService_AddDataSource_FullMethodName      = "/devsecdb.v1.InstanceService/AddDataSource"
	InstanceService_RemoveDataSource_FullMethodName   = "/devsecdb.v1.InstanceService/RemoveDataSource"
	InstanceService_UpdateDataSource_FullMethodName   = "/devsecdb.v1.InstanceService/UpdateDataSource"
	InstanceService_SyncSlowQueries_FullMethodName    = "/devsecdb.v1.InstanceService/SyncSlowQueries"
)
...
var InstanceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devsecdb.v1.InstanceService",
