...
const (
	EnvironmentService_GetEnvironment_FullMethodName      = "/devsecdb.v1.EnvironmentService/GetEnvironment"
	EnvironmentService_ListEnvironments_FullMethodName    = "/devsecdb.v1.EnvironmentService/ListEnvironments"
	EnvironmentService_CreateEnvironment_FullMethodName   = "/devsecdb.v1.EnvironmentService/CreateEnvironment"
	EnvironmentService_UpdateEnvironment_FullMethodName   = "/devsecdb.v1.EnvironmentService/UpdateEnvironment"
	EnvironmentService_DeleteEnvironment_FullMethodName   = "/devsecdb.v1.EnvironmentService/DeleteEnvironment"
	EnvironmentService_UndeleteEnvironment_FullMethodName = "/devsecdb.v1.EnvironmentService/UndeleteEnvironment"
)
...
func (c *environmentServiceClient) UndeleteEnvironment(ctx context.Context, in *UndeleteEnvironmentRequest, opts ...grpc.CallOption) (*Environment, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Environment)
	err := c.cc.Invoke(ctx, EnvironmentService_UndeleteEnvironment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EnvironmentService_UndeleteEnvironment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EnvironmentService_UndeleteEnvironment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var EnvironmentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devsecdb.v1.EnvironmentService",
