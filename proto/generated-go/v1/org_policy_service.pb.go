...
type CreatePolicyRequest struct {
	...
	Type   PolicyType `protobuf:"varint,3,opt,name=type,proto3,enum=devsecdb.v1.PolicyType" json:"type,omitempty"`
}
...
type ListPoliciesRequest struct {
	...
	Parent     string      `protobuf:"bytes,1,opt,name=parent,proto3" json:"parent,omitempty"`
	PolicyType *PolicyType `protobuf:"varint,2,opt,name=policy_type,json=policyType,proto3,enum=devsecdb.v1.PolicyType,oneof" json:"policy_type,omitempty"`
	// Not used.
...
type Policy struct {
	...
	Type              PolicyType `protobuf:"varint,5,opt,name=type,proto3,enum=devsecdb.v1.PolicyType" json:"type,omitempty"`
	...
	ResourceType PolicyResourceType `protobuf:"varint,14,opt,name=resource_type,json=resourceType,proto3,enum=devsecdb.v1.PolicyResourceType" json:"resource_type,omitempty"`
}
...
type MaskData struct {
	...
	MaskingLevel              MaskingLevel `protobuf:"varint,4,opt,name=masking_level,json=maskingLevel,proto3,enum=devsecdb.v1.MaskingLevel" json:"masking_level,omitempty"`
...
type SQLReviewRule struct {
	...
	Level   SQLReviewRuleLevel `protobuf:"varint,2,opt,name=level,proto3,enum=devsecdb.v1.SQLReviewRuleLevel" json:"level,omitempty"`
	Payload string             `protobuf:"bytes,3,opt,name=payload,proto3" json:"payload,omitempty"`
	Engine  Engine             `protobuf:"varint,4,opt,name=engine,proto3,enum=devsecdb.v1.Engine" json:"engine,omitempty"`
...
type DataSourceQueryPolicy struct {
	...
	AdminDataSourceRestriction DataSourceQueryPolicy_Restriction `protobuf:"varint,1,opt,name=admin_data_source_restriction,json=adminDataSourceRestriction,proto3,enum=devsecdb.v1.DataSourceQueryPolicy_Restriction" json:"admin_data_source_restriction,omitempty"`
...
type MaskingExceptionPolicy_MaskingException struct {
	...
	Action MaskingExceptionPolicy_MaskingException_Action `protobuf:"varint,1,opt,name=action,proto3,enum=devsecdb.v1.MaskingExceptionPolicy_MaskingException_Action" json:"action,omitempty"`
	// Level is the masking level that the user can access sensitive data.
	MaskingLevel MaskingLevel `protobuf:"varint,2,opt,name=masking_level,json=maskingLevel,proto3,enum=devsecdb.v1.MaskingLevel" json:"masking_level,omitempty"`
	// Member is the principal who bind to this exception policy instance.
	//
	// - `user:{email}`: An email address that represents a specific Devsecdb account. For example, `alice@example.com`.
...
type MaskingRulePolicy_MaskingRule struct {
	...
	MaskingLevel MaskingLevel `protobuf:"varint,3,opt,name=masking_level,json=maskingLevel,proto3,enum=devsecdb.v1.MaskingLevel" json:"masking_level,omitempty"`
}
...
var file_v1_org_policy_service_proto_goTypes = []any{
	(PolicyType)(0),         // 0: devsecdb.v1.PolicyType
	(PolicyResourceType)(0), // 1: devsecdb.v1.PolicyResourceType
	(SQLReviewRuleLevel)(0), // 2: devsecdb.v1.SQLReviewRuleLevel
	(MaskingExceptionPolicy_MaskingException_Action)(0), // 3: devsecdb.v1.MaskingExceptionPolicy.MaskingException.Action
	(DataSourceQueryPolicy_Restriction)(0),              // 4: devsecdb.v1.DataSourceQueryPolicy.Restriction
	(*CreatePolicyRequest)(nil),                         // 5: devsecdb.v1.CreatePolicyRequest
	(*UpdatePolicyRequest)(nil),                         // 6: devsecdb.v1.UpdatePolicyRequest
	(*DeletePolicyRequest)(nil),                         // 7: devsecdb.v1.DeletePolicyRequest
	(*GetPolicyRequest)(nil),                            // 8: devsecdb.v1.GetPolicyRequest
	(*ListPoliciesRequest)(nil),                         // 9: devsecdb.v1.ListPoliciesRequest
	(*ListPoliciesResponse)(nil),                        // 10: devsecdb.v1.ListPoliciesResponse
	(*Policy)(nil),                                      // 11: devsecdb.v1.Policy
	(*RolloutPolicy)(nil),                               // 12: devsecdb.v1.RolloutPolicy
	(*SlowQueryPolicy)(nil),                             // 13: devsecdb.v1.SlowQueryPolicy
	(*DisableCopyDataPolicy)(nil),                       // 14: devsecdb.v1.DisableCopyDataPolicy
	(*ExportDataPolicy)(nil),                            // 15: devsecdb.v1.ExportDataPolicy
	(*MaskingPolicy)(nil),                               // 16: devsecdb.v1.MaskingPolicy
	(*MaskData)(nil),                                    // 17: devsecdb.v1.MaskData
	(*SQLReviewRule)(nil),                               // 18: devsecdb.v1.SQLReviewRule
	(*MaskingExceptionPolicy)(nil),                      // 19: devsecdb.v1.MaskingExceptionPolicy
	(*MaskingRulePolicy)(nil),                           // 20: devsecdb.v1.MaskingRulePolicy
	(*RestrictIssueCreationForSQLReviewPolicy)(nil),     // 21: devsecdb.v1.RestrictIssueCreationForSQLReviewPolicy
	(*TagPolicy)(nil),                                   // 22: devsecdb.v1.TagPolicy
	(*DataSourceQueryPolicy)(nil),                       // 23: devsecdb.v1.DataSourceQueryPolicy
	(*MaskingExceptionPolicy_MaskingException)(nil),     // 24: devsecdb.v1.MaskingExceptionPolicy.MaskingException
	(*MaskingRulePolicy_MaskingRule)(nil),               // 25: devsecdb.v1.MaskingRulePolicy.MaskingRule
	nil,                                                 // 26: devsecdb.v1.TagPolicy.TagsEntry
	(*fieldmaskpb.FieldMask)(nil),                       // 27: google.protobuf.FieldMask
	(MaskingLevel)(0),                                   // 28: devsecdb.v1.MaskingLevel
	(Engine)(0),                                         // 29: devsecdb.v1.Engine
	(*expr.Expr)(nil),                                   // 30: google.type.Expr
	(*emptypb.Empty)(nil),                               // 31: google.protobuf.Empty
}
var file_v1_org_policy_service_proto_depIdxs = []int32{
	11, // 0: devsecdb.v1.CreatePolicyRequest.policy:type_name -> devsecdb.v1.Policy
	0,  // 1: devsecdb.v1.CreatePolicyRequest.type:type_name -> devsecdb.v1.PolicyType
	11, // 2: devsecdb.v1.UpdatePolicyRequest.policy:type_name -> devsecdb.v1.Policy
	27, // 3: devsecdb.v1.UpdatePolicyRequest.update_mask:type_name -> google.protobuf.FieldMask
	0,  // 4: devsecdb.v1.ListPoliciesRequest.policy_type:type_name -> devsecdb.v1.PolicyType
	11, // 5: devsecdb.v1.ListPoliciesResponse.policies:type_name -> devsecdb.v1.Policy
	0,  // 6: devsecdb.v1.Policy.type:type_name -> devsecdb.v1.PolicyType
	12, // 7: devsecdb.v1.Policy.rollout_policy:type_name -> devsecdb.v1.RolloutPolicy
	16, // 8: devsecdb.v1.Policy.masking_policy:type_name -> devsecdb.v1.MaskingPolicy
	13, // 9: devsecdb.v1.Policy.slow_query_policy:type_name -> devsecdb.v1.SlowQueryPolicy
	14, // 10: devsecdb.v1.Policy.disable_copy_data_policy:type_name -> devsecdb.v1.DisableCopyDataPolicy
	20, // 11: devsecdb.v1.Policy.masking_rule_policy:type_name -> devsecdb.v1.MaskingRulePolicy
	19, // 12: devsecdb.v1.Policy.masking_exception_policy:type_name -> devsecdb.v1.MaskingExceptionPolicy
	21, // 13: devsecdb.v1.Policy.restrict_issue_creation_for_sql_review_policy:type_name -> devsecdb.v1.RestrictIssueCreationForSQLReviewPolicy
	22, // 14: devsecdb.v1.Policy.tag_policy:type_name -> devsecdb.v1.TagPolicy
	23, // 15: devsecdb.v1.Policy.data_source_query_policy:type_name -> devsecdb.v1.DataSourceQueryPolicy
	15, // 16: devsecdb.v1.Policy.export_data_policy:type_name -> devsecdb.v1.ExportDataPolicy
	1,  // 17: devsecdb.v1.Policy.resource_type:type_name -> devsecdb.v1.PolicyResourceType
	17, // 18: devsecdb.v1.MaskingPolicy.mask_data:type_name -> devsecdb.v1.MaskData
	28, // 19: devsecdb.v1.MaskData.masking_level:type_name -> devsecdb.v1.MaskingLevel
	2,  // 20: devsecdb.v1.SQLReviewRule.level:type_name -> devsecdb.v1.SQLReviewRuleLevel
	29, // 21: devsecdb.v1.SQLReviewRule.engine:type_name -> devsecdb.v1.Engine
	24, // 22: devsecdb.v1.MaskingExceptionPolicy.masking_exceptions:type_name -> devsecdb.v1.MaskingExceptionPolicy.MaskingException
	25, // 23: devsecdb.v1.MaskingRulePolicy.rules:type_name -> devsecdb.v1.MaskingRulePolicy.MaskingRule
	26, // 24: devsecdb.v1.TagPolicy.tags:type_name -> devsecdb.v1.TagPolicy.TagsEntry
	4,  // 25: devsecdb.v1.DataSourceQueryPolicy.admin_data_source_restriction:type_name -> devsecdb.v1.DataSourceQueryPolicy.Restriction
	3,  // 26: devsecdb.v1.MaskingExceptionPolicy.MaskingException.action:type_name -> devsecdb.v1.MaskingExceptionPolicy.MaskingException.Action
	28, // 27: devsecdb.v1.MaskingExceptionPolicy.MaskingException.masking_level:type_name -> devsecdb.v1.MaskingLevel
	30, // 28: devsecdb.v1.MaskingExceptionPolicy.MaskingException.condition:type_name -> google.type.Expr
	30, // 29: devsecdb.v1.MaskingRulePolicy.MaskingRule.condition:type_name -> google.type.Expr
	28, // 30: devsecdb.v1.MaskingRulePolicy.MaskingRule.masking_level:type_name -> devsecdb.v1.MaskingLevel
	8,  // 31: devsecdb.v1.OrgPolicyService.GetPolicy:input_type -> devsecdb.v1.GetPolicyRequest
	9,  // 32: devsecdb.v1.OrgPolicyService.ListPolicies:input_type -> devsecdb.v1.ListPoliciesRequest
	5,  // 33: devsecdb.v1.OrgPolicyService.CreatePolicy:input_type -> devsecdb.v1.CreatePolicyRequest
	6,  // 34: devsecdb.v1.OrgPolicyService.UpdatePolicy:input_type -> devsecdb.v1.UpdatePolicyRequest
	7,  // 35: devsecdb.v1.OrgPolicyService.DeletePolicy:input_type -> devsecdb.v1.DeletePolicyRequest
	11, // 36: devsecdb.v1.OrgPolicyService.GetPolicy:output_type -> devsecdb.v1.Policy
	10, // 37: devsecdb.v1.OrgPolicyService.ListPolicies:output_type -> devsecdb.v1.ListPoliciesResponse
	11, // 38: devsecdb.v1.OrgPolicyService.CreatePolicy:output_type -> devsecdb.v1.Policy
	11, // 39: devsecdb.v1.OrgPolicyService.UpdatePolicy:output_type -> devsecdb.v1.Policy
	31, // 40: devsecdb.v1.OrgPolicyService.DeletePolicy:output_type -> google.protobuf.Empty
