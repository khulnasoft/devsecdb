...
var file_v1_cel_service_proto_goTypes = []any{
	(*BatchParseRequest)(nil),    // 0: devsecdb.v1.BatchParseRequest
	(*BatchParseResponse)(nil),   // 1: devsecdb.v1.BatchParseResponse
	(*BatchDeparseRequest)(nil),  // 2: devsecdb.v1.BatchDeparseRequest
	(*BatchDeparseResponse)(nil), // 3: devsecdb.v1.BatchDeparseResponse
	(*v1alpha1.Expr)(nil),        // 4: google.api.expr.v1alpha1.Expr
}
var file_v1_cel_service_proto_depIdxs = []int32{
	4, // 0: devsecdb.v1.BatchParseResponse.expressions:type_name -> google.api.expr.v1alpha1.Expr
	4, // 1: devsecdb.v1.BatchDeparseRequest.expressions:type_name -> google.api.expr.v1alpha1.Expr
	0, // 2: devsecdb.v1.CelService.BatchParse:input_type -> devsecdb.v1.BatchParseRequest
	2, // 3: devsecdb.v1.CelService.BatchDeparse:input_type -> devsecdb.v1.BatchDeparseRequest
	1, // 4: devsecdb.v1.CelService.BatchParse:output_type -> devsecdb.v1.BatchParseResponse
	3, // 5: devsecdb.v1.CelService.BatchDeparse:output_type -> devsecdb.v1.BatchDeparseResponse
