...
func RegisterReviewConfigServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ReviewConfigServiceServer) error {
	...
	mux.Handle("POST", pattern_ReviewConfigService_CreateReviewConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.ReviewConfigService/CreateReviewConfig", runtime.WithHTTPPathPattern("/v1/reviewConfigs"))
		if err != nil {
	...
	mux.Handle("GET", pattern_ReviewConfigService_ListReviewConfigs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.ReviewConfigService/ListReviewConfigs", runtime.WithHTTPPathPattern("/v1/reviewConfigs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ReviewConfigService_GetReviewConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.ReviewConfigService/GetReviewConfig", runtime.WithHTTPPathPattern("/v1/{name=reviewConfigs/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_ReviewConfigService_UpdateReviewConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.ReviewConfigService/UpdateReviewConfig", runtime.WithHTTPPathPattern("/v1/{review_config.name=reviewConfigs/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_ReviewConfigService_DeleteReviewConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.ReviewConfigService/DeleteReviewConfig", runtime.WithHTTPPathPattern("/v1/{name=reviewConfigs/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterReviewConfigServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ReviewConfigServiceClient) error {
	...
	mux.Handle("POST", pattern_ReviewConfigService_CreateReviewConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.ReviewConfigService/CreateReviewConfig", runtime.WithHTTPPathPattern("/v1/reviewConfigs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ReviewConfigService_ListReviewConfigs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.ReviewConfigService/ListReviewConfigs", runtime.WithHTTPPathPattern("/v1/reviewConfigs"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ReviewConfigService_GetReviewConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.ReviewConfigService/GetReviewConfig", runtime.WithHTTPPathPattern("/v1/{name=reviewConfigs/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_ReviewConfigService_UpdateReviewConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.ReviewConfigService/UpdateReviewConfig", runtime.WithHTTPPathPattern("/v1/{review_config.name=reviewConfigs/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_ReviewConfigService_DeleteReviewConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.ReviewConfigService/DeleteReviewConfig", runtime.WithHTTPPathPattern("/v1/{name=reviewConfigs/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
