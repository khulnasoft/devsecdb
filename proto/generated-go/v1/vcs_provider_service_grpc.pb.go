...
const (
	VCSProviderService_GetVCSProvider_FullMethodName                = "/devsecdb.v1.VCSProviderService/GetVCSProvider"
	VCSProviderService_ListVCSProviders_FullMethodName              = "/devsecdb.v1.VCSProviderService/ListVCSProviders"
	VCSProviderService_CreateVCSProvider_FullMethodName             = "/devsecdb.v1.VCSProviderService/CreateVCSProvider"
	VCSProviderService_UpdateVCSProvider_FullMethodName             = "/devsecdb.v1.VCSProviderService/UpdateVCSProvider"
	VCSProviderService_DeleteVCSProvider_FullMethodName             = "/devsecdb.v1.VCSProviderService/DeleteVCSProvider"
	VCSProviderService_SearchVCSProviderRepositories_FullMethodName = "/devsecdb.v1.VCSProviderService/SearchVCSProviderRepositories"
	VCSProviderService_ListVCSConnectorsInProvider_FullMethodName   = "/devsecdb.v1.VCSProviderService/ListVCSConnectorsInProvider"
)
...
func (c *vCSProviderServiceClient) GetVCSProvider(ctx context.Context, in *GetVCSProviderRequest, opts ...grpc.CallOption) (*VCSProvider, error) {
	...
	out := new(VCSProvider)
	err := c.cc.Invoke(ctx, VCSProviderService_GetVCSProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vCSProviderServiceClient) ListVCSProviders(ctx context.Context, in *ListVCSProvidersRequest, opts ...grpc.CallOption) (*ListVCSProvidersResponse, error) {
	...
	err := c.cc.Invoke(ctx, VCSProviderService_ListVCSProviders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vCSProviderServiceClient) CreateVCSProvider(ctx context.Context, in *CreateVCSProviderRequest, opts ...grpc.CallOption) (*VCSProvider, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VCSProvider)
	err := c.cc.Invoke(ctx, VCSProviderService_CreateVCSProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vCSProviderServiceClient) UpdateVCSProvider(ctx context.Context, in *UpdateVCSProviderRequest, opts ...grpc.CallOption) (*VCSProvider, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VCSProvider)
	err := c.cc.Invoke(ctx, VCSProviderService_UpdateVCSProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vCSProviderServiceClient) DeleteVCSProvider(ctx context.Context, in *DeleteVCSProviderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, VCSProviderService_DeleteVCSProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vCSProviderServiceClient) SearchVCSProviderRepositories(ctx context.Context, in *SearchVCSProviderRepositoriesRequest, opts ...grpc.CallOption) (*SearchVCSProviderRepositoriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, VCSProviderService_SearchVCSProviderRepositories_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vCSProviderServiceClient) ListVCSConnectorsInProvider(ctx context.Context, in *ListVCSConnectorsInProviderRequest, opts ...grpc.CallOption) (*ListVCSConnectorsInProviderResponse, error) {
	...
	err := c.cc.Invoke(ctx, VCSProviderService_ListVCSConnectorsInProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedVCSProviderServiceServer must be embedded to have
...
func (UnimplementedVCSProviderServiceServer) testEmbeddedByValue()                            {}
...
func RegisterVCSProviderServiceServer(s grpc.ServiceRegistrar, srv VCSProviderServiceServer) {
	// If the following call pancis, it indicates UnimplementedVCSProviderServiceServer was
...
var VCSProviderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devsecdb.v1.VCSProviderService",
