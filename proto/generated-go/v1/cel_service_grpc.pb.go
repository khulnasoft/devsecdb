...
const (
	CelService_BatchParse_FullMethodName   = "/devsecdb.v1.CelService/BatchParse"
	CelService_BatchDeparse_FullMethodName = "/devsecdb.v1.CelService/BatchDeparse"
)
...
func RegisterCelServiceServer(s grpc.ServiceRegistrar, srv CelServiceServer) {
	// If the following call pancis, it indicates UnimplementedCelServiceServer was
...
var CelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devsecdb.v1.CelService",
