...
const (
	DatabaseGroupService_ListDatabaseGroups_FullMethodName  = "/devsecdb.v1.DatabaseGroupService/ListDatabaseGroups"
	DatabaseGroupService_GetDatabaseGroup_FullMethodName    = "/devsecdb.v1.DatabaseGroupService/GetDatabaseGroup"
	DatabaseGroupService_CreateDatabaseGroup_FullMethodName = "/devsecdb.v1.DatabaseGroupService/CreateDatabaseGroup"
	DatabaseGroupService_UpdateDatabaseGroup_FullMethodName = "/devsecdb.v1.DatabaseGroupService/UpdateDatabaseGroup"
	DatabaseGroupService_DeleteDatabaseGroup_FullMethodName = "/devsecdb.v1.DatabaseGroupService/DeleteDatabaseGroup"
)
...
func RegisterDatabaseGroupServiceServer(s grpc.ServiceRegistrar, srv DatabaseGroupServiceServer) {
	// If the following call pancis, it indicates UnimplementedDatabaseGroupServiceServer was
...
var DatabaseGroupService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devsecdb.v1.DatabaseGroupService",
