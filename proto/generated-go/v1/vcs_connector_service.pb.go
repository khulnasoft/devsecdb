...
type VCSConnector struct {
	...
	// The root directory where Devsecdb observes the file change. If empty, then it observes the entire repository.
	BaseDirectory string `protobuf:"bytes,9,opt,name=base_directory,json=baseDirectory,proto3" json:"base_directory,omitempty"`
	// The branch Devsecdb listens to for changes. For example: main.
	...
	// The full_path of the repository. For example: devsecdb/sample.
	FullPath string `protobuf:"bytes,12,opt,name=full_path,json=fullPath,proto3" json:"full_path,omitempty"`
	// The web url of the repository. For axample: https://gitlab.secdb.khulnasoft.com/devsecdb/sample.
...
var file_v1_vcs_connector_service_proto_goTypes = []any{
	(*CreateVCSConnectorRequest)(nil), // 0: devsecdb.v1.CreateVCSConnectorRequest
	(*GetVCSConnectorRequest)(nil),    // 1: devsecdb.v1.GetVCSConnectorRequest
	(*ListVCSConnectorsRequest)(nil),  // 2: devsecdb.v1.ListVCSConnectorsRequest
	(*ListVCSConnectorsResponse)(nil), // 3: devsecdb.v1.ListVCSConnectorsResponse
	(*UpdateVCSConnectorRequest)(nil), // 4: devsecdb.v1.UpdateVCSConnectorRequest
	(*DeleteVCSConnectorRequest)(nil), // 5: devsecdb.v1.DeleteVCSConnectorRequest
	(*VCSConnector)(nil),              // 6: devsecdb.v1.VCSConnector
	(*fieldmaskpb.FieldMask)(nil),     // 7: google.protobuf.FieldMask
	(*timestamppb.Timestamp)(nil),     // 8: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),             // 9: google.protobuf.Empty
}
var file_v1_vcs_connector_service_proto_depIdxs = []int32{
	6,  // 0: devsecdb.v1.CreateVCSConnectorRequest.vcs_connector:type_name -> devsecdb.v1.VCSConnector
	6,  // 1: devsecdb.v1.ListVCSConnectorsResponse.vcs_connectors:type_name -> devsecdb.v1.VCSConnector
	6,  // 2: devsecdb.v1.UpdateVCSConnectorRequest.vcs_connector:type_name -> devsecdb.v1.VCSConnector
	7,  // 3: devsecdb.v1.UpdateVCSConnectorRequest.update_mask:type_name -> google.protobuf.FieldMask
	8,  // 4: devsecdb.v1.VCSConnector.create_time:type_name -> google.protobuf.Timestamp
	8,  // 5: devsecdb.v1.VCSConnector.update_time:type_name -> google.protobuf.Timestamp
	0,  // 6: devsecdb.v1.VCSConnectorService.CreateVCSConnector:input_type -> devsecdb.v1.CreateVCSConnectorRequest
	1,  // 7: devsecdb.v1.VCSConnectorService.GetVCSConnector:input_type -> devsecdb.v1.GetVCSConnectorRequest
	2,  // 8: devsecdb.v1.VCSConnectorService.ListVCSConnectors:input_type -> devsecdb.v1.ListVCSConnectorsRequest
	4,  // 9: devsecdb.v1.VCSConnectorService.UpdateVCSConnector:input_type -> devsecdb.v1.UpdateVCSConnectorRequest
	5,  // 10: devsecdb.v1.VCSConnectorService.DeleteVCSConnector:input_type -> devsecdb.v1.DeleteVCSConnectorRequest
	6,  // 11: devsecdb.v1.VCSConnectorService.CreateVCSConnector:output_type -> devsecdb.v1.VCSConnector
	6,  // 12: devsecdb.v1.VCSConnectorService.GetVCSConnector:output_type -> devsecdb.v1.VCSConnector
	3,  // 13: devsecdb.v1.VCSConnectorService.ListVCSConnectors:output_type -> devsecdb.v1.ListVCSConnectorsResponse
	6,  // 14: devsecdb.v1.VCSConnectorService.UpdateVCSConnector:output_type -> devsecdb.v1.VCSConnector
	9,  // 15: devsecdb.v1.VCSConnectorService.DeleteVCSConnector:output_type -> google.protobuf.Empty
