...
func RegisterCelServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CelServiceServer) error {
	...
	mux.Handle("POST", pattern_CelService_BatchParse_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.CelService/BatchParse", runtime.WithHTTPPathPattern("/v1/cel/batchParse"))
		if err != nil {
	...
	mux.Handle("POST", pattern_CelService_BatchDeparse_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.CelService/BatchDeparse", runtime.WithHTTPPathPattern("/v1/cel/batchDeparse"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterCelServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CelServiceClient) error {
	...
	mux.Handle("POST", pattern_CelService_BatchParse_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.CelService/BatchParse", runtime.WithHTTPPathPattern("/v1/cel/batchParse"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_CelService_BatchDeparse_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.CelService/BatchDeparse", runtime.WithHTTPPathPattern("/v1/cel/batchDeparse"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
