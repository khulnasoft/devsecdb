...
const (
	SheetService_CreateSheet_FullMethodName      = "/devsecdb.v1.SheetService/CreateSheet"
	SheetService_BatchCreateSheet_FullMethodName = "/devsecdb.v1.SheetService/BatchCreateSheet"
	SheetService_GetSheet_FullMethodName         = "/devsecdb.v1.SheetService/GetSheet"
	SheetService_UpdateSheet_FullMethodName      = "/devsecdb.v1.SheetService/UpdateSheet"
)
...
func RegisterSheetServiceServer(s grpc.ServiceRegistrar, srv SheetServiceServer) {
	// If the following call pancis, it indicates UnimplementedSheetServiceServer was
...
var SheetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "devsecdb.v1.SheetService",
