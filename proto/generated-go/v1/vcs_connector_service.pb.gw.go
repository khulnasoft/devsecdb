...
func RegisterVCSConnectorServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server VCSConnectorServiceServer) error {
	...
	mux.Handle("POST", pattern_VCSConnectorService_CreateVCSConnector_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.VCSConnectorService/CreateVCSConnector", runtime.WithHTTPPathPattern("/v1/{parent=projects/*}/vcsConnectors"))
		if err != nil {
	...
	mux.Handle("GET", pattern_VCSConnectorService_GetVCSConnector_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.VCSConnectorService/GetVCSConnector", runtime.WithHTTPPathPattern("/v1/{name=projects/*/vcsConnectors/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_VCSConnectorService_ListVCSConnectors_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.VCSConnectorService/ListVCSConnectors", runtime.WithHTTPPathPattern("/v1/{parent=projects/*}/vcsConnectors"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_VCSConnectorService_UpdateVCSConnector_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.VCSConnectorService/UpdateVCSConnector", runtime.WithHTTPPathPattern("/v1/{vcs_connector.name=projects/*/vcsConnectors/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_VCSConnectorService_DeleteVCSConnector_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/devsecdb.v1.VCSConnectorService/DeleteVCSConnector", runtime.WithHTTPPathPattern("/v1/{name=projects/*/vcsConnectors/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterVCSConnectorServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client VCSConnectorServiceClient) error {
	...
	mux.Handle("POST", pattern_VCSConnectorService_CreateVCSConnector_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.VCSConnectorService/CreateVCSConnector", runtime.WithHTTPPathPattern("/v1/{parent=projects/*}/vcsConnectors"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_VCSConnectorService_GetVCSConnector_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.VCSConnectorService/GetVCSConnector", runtime.WithHTTPPathPattern("/v1/{name=projects/*/vcsConnectors/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_VCSConnectorService_ListVCSConnectors_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.VCSConnectorService/ListVCSConnectors", runtime.WithHTTPPathPattern("/v1/{parent=projects/*}/vcsConnectors"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_VCSConnectorService_UpdateVCSConnector_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.VCSConnectorService/UpdateVCSConnector", runtime.WithHTTPPathPattern("/v1/{vcs_connector.name=projects/*/vcsConnectors/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_VCSConnectorService_DeleteVCSConnector_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/devsecdb.v1.VCSConnectorService/DeleteVCSConnector", runtime.WithHTTPPathPattern("/v1/{name=projects/*/vcsConnectors/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
