...
type IssueCommentPayload_Approval struct {
	...
	Status IssueCommentPayload_Approval_Status `protobuf:"varint,1,opt,name=status,proto3,enum=devsecdb.store.IssueCommentPayload_Approval_Status" json:"status,omitempty"`
}
...
type IssueCommentPayload_IssueUpdate struct {
	...
	FromStatus      *IssueCommentPayload_IssueUpdate_IssueStatus `protobuf:"varint,5,opt,name=from_status,json=fromStatus,proto3,enum=devsecdb.store.IssueCommentPayload_IssueUpdate_IssueStatus,oneof" json:"from_status,omitempty"`
	ToStatus        *IssueCommentPayload_IssueUpdate_IssueStatus `protobuf:"varint,6,opt,name=to_status,json=toStatus,proto3,enum=devsecdb.store.IssueCommentPayload_IssueUpdate_IssueStatus,oneof" json:"to_status,omitempty"`
...
type IssueCommentPayload_TaskUpdate struct {
	...
	ToStatus                *IssueCommentPayload_TaskUpdate_Status `protobuf:"varint,6,opt,name=to_status,json=toStatus,proto3,enum=devsecdb.store.IssueCommentPayload_TaskUpdate_Status,oneof" json:"to_status,omitempty"`
}
...
var file_store_issue_comment_proto_goTypes = []any{
	(IssueCommentPayload_Approval_Status)(0),          // 0: devsecdb.store.IssueCommentPayload.Approval.Status
	(IssueCommentPayload_IssueUpdate_IssueStatus)(0),  // 1: devsecdb.store.IssueCommentPayload.IssueUpdate.IssueStatus
	(IssueCommentPayload_TaskUpdate_Status)(0),        // 2: devsecdb.store.IssueCommentPayload.TaskUpdate.Status
	(*IssueCommentPayload)(nil),                       // 3: devsecdb.store.IssueCommentPayload
	(*IssueCommentPayload_Approval)(nil),              // 4: devsecdb.store.IssueCommentPayload.Approval
	(*IssueCommentPayload_IssueUpdate)(nil),           // 5: devsecdb.store.IssueCommentPayload.IssueUpdate
	(*IssueCommentPayload_StageEnd)(nil),              // 6: devsecdb.store.IssueCommentPayload.StageEnd
	(*IssueCommentPayload_TaskUpdate)(nil),            // 7: devsecdb.store.IssueCommentPayload.TaskUpdate
	(*IssueCommentPayload_TaskPriorBackup)(nil),       // 8: devsecdb.store.IssueCommentPayload.TaskPriorBackup
	(*IssueCommentPayload_TaskPriorBackup_Table)(nil), // 9: devsecdb.store.IssueCommentPayload.TaskPriorBackup.Table
	(*timestamppb.Timestamp)(nil),                     // 10: google.protobuf.Timestamp
}
var file_store_issue_comment_proto_depIdxs = []int32{
	4,  // 0: devsecdb.store.IssueCommentPayload.approval:type_name -> devsecdb.store.IssueCommentPayload.Approval
	5,  // 1: devsecdb.store.IssueCommentPayload.issue_update:type_name -> devsecdb.store.IssueCommentPayload.IssueUpdate
	6,  // 2: devsecdb.store.IssueCommentPayload.stage_end:type_name -> devsecdb.store.IssueCommentPayload.StageEnd
	7,  // 3: devsecdb.store.IssueCommentPayload.task_update:type_name -> devsecdb.store.IssueCommentPayload.TaskUpdate
	8,  // 4: devsecdb.store.IssueCommentPayload.task_prior_backup:type_name -> devsecdb.store.IssueCommentPayload.TaskPriorBackup
	0,  // 5: devsecdb.store.IssueCommentPayload.Approval.status:type_name -> devsecdb.store.IssueCommentPayload.Approval.Status
	1,  // 6: devsecdb.store.IssueCommentPayload.IssueUpdate.from_status:type_name -> devsecdb.store.IssueCommentPayload.IssueUpdate.IssueStatus
	1,  // 7: devsecdb.store.IssueCommentPayload.IssueUpdate.to_status:type_name -> devsecdb.store.IssueCommentPayload.IssueUpdate.IssueStatus
	10, // 8: devsecdb.store.IssueCommentPayload.TaskUpdate.from_earliest_allowed_time:type_name -> google.protobuf.Timestamp
	10, // 9: devsecdb.store.IssueCommentPayload.TaskUpdate.to_earliest_allowed_time:type_name -> google.protobuf.Timestamp
	2,  // 10: devsecdb.store.IssueCommentPayload.TaskUpdate.to_status:type_name -> devsecdb.store.IssueCommentPayload.TaskUpdate.Status
	9,  // 11: devsecdb.store.IssueCommentPayload.TaskPriorBackup.tables:type_name -> devsecdb.store.IssueCommentPayload.TaskPriorBackup.Table
