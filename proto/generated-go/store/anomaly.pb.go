...
var file_store_anomaly_proto_rawDesc = []byte{
...
var (
	...
	file_store_anomaly_proto_rawDescData = file_store_anomaly_proto_rawDesc
)

func file_store_anomaly_proto_rawDescGZIP() []byte {
	file_store_anomaly_proto_rawDescOnce.Do(func() {
		file_store_anomaly_proto_rawDescData = protoimpl.X.CompressGZIP(file_store_anomaly_proto_rawDescData)
	})
...
var file_store_anomaly_proto_goTypes = []any{
	(*AnomalyConnectionPayload)(nil),          // 0: devsecdb.store.AnomalyConnectionPayload
	(*AnomalyDatabaseSchemaDriftPayload)(nil), // 1: devsecdb.store.AnomalyDatabaseSchemaDriftPayload
}
...
func file_store_anomaly_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_store_anomaly_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_store_anomaly_proto_rawDesc = nil
