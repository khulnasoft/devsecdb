...
type Advice struct {
	...
	// The advice status.
	Status Advice_Status `protobuf:"varint,1,opt,name=status,proto3,enum=devsecdb.store.Advice_Status" json:"status,omitempty"`
	// The advice code.
...
var file_store_advice_proto_goTypes = []any{
	(Advice_Status)(0), // 0: devsecdb.store.Advice.Status
	(*Advice)(nil),     // 1: devsecdb.store.Advice
	(*Position)(nil),   // 2: devsecdb.store.Position
}
var file_store_advice_proto_depIdxs = []int32{
	0, // 0: devsecdb.store.Advice.status:type_name -> devsecdb.store.Advice.Status
	2, // 1: devsecdb.store.Advice.start_position:type_name -> devsecdb.store.Position
	2, // 2: devsecdb.store.Advice.end_position:type_name -> devsecdb.store.Position
