...
var file_store_project_proto_rawDesc = []byte{
	...
	0x22, 0xaa, 0x03, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x38, 0x0a, 0x0c,
	...
	0x61, 0x6e, 0x74, 0x4d, 0x6f, 0x64, 0x65, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02, 0x42, 0x14, 0x5a,
...
var file_store_project_proto_goTypes = []any{
	(*Label)(nil),   // 0: devsecdb.store.Label
	(*Project)(nil), // 1: devsecdb.store.Project
}
var file_store_project_proto_depIdxs = []int32{
	0, // 0: devsecdb.store.Project.issue_labels:type_name -> devsecdb.store.Label
