...
type ChangelogTask struct {
	...
	Status            ChangelogTask_Status `protobuf:"varint,5,opt,name=status,proto3,enum=devsecdb.store.ChangelogTask_Status" json:"status,omitempty"`
	...
	Type    ChangelogTask_Type `protobuf:"varint,10,opt,name=type,proto3,enum=devsecdb.store.ChangelogTask_Type" json:"type,omitempty"`
}
...
type ChangelogRevision struct {
	...
	Operation ChangelogRevision_Op `protobuf:"varint,2,opt,name=operation,proto3,enum=devsecdb.store.ChangelogRevision_Op" json:"operation,omitempty"`
}
...
var file_store_changelog_proto_goTypes = []any{
	(ChangelogTask_Status)(0), // 0: devsecdb.store.ChangelogTask.Status
	(ChangelogTask_Type)(0),   // 1: devsecdb.store.ChangelogTask.Type
	(ChangelogRevision_Op)(0), // 2: devsecdb.store.ChangelogRevision.Op
	(*ChangelogPayload)(nil),  // 3: devsecdb.store.ChangelogPayload
	(*ChangelogTask)(nil),     // 4: devsecdb.store.ChangelogTask
	(*ChangelogRevision)(nil), // 5: devsecdb.store.ChangelogRevision
	(*ChangedResources)(nil),  // 6: devsecdb.store.ChangedResources
}
var file_store_changelog_proto_depIdxs = []int32{
	4, // 0: devsecdb.store.ChangelogPayload.task:type_name -> devsecdb.store.ChangelogTask
	5, // 1: devsecdb.store.ChangelogPayload.revision:type_name -> devsecdb.store.ChangelogRevision
	6, // 2: devsecdb.store.ChangelogTask.changed_resources:type_name -> devsecdb.store.ChangedResources
	0, // 3: devsecdb.store.ChangelogTask.status:type_name -> devsecdb.store.ChangelogTask.Status
	1, // 4: devsecdb.store.ChangelogTask.type:type_name -> devsecdb.store.ChangelogTask.Type
	2, // 5: devsecdb.store.ChangelogRevision.operation:type_name -> devsecdb.store.ChangelogRevision.Op
