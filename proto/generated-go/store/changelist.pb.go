...
var file_store_changelist_proto_goTypes = []any{
	(*Changelist)(nil),        // 0: devsecdb.store.Changelist
	(*Changelist_Change)(nil), // 1: devsecdb.store.Changelist.Change
}
var file_store_changelist_proto_depIdxs = []int32{
	1, // 0: devsecdb.store.Changelist.changes:type_name -> devsecdb.store.Changelist.Change
