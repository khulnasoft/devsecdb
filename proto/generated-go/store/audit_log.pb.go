...
type AuditLog struct {
	...
	// e.g. /devsecdb.v1.SQLService/Query
	...
	Severity AuditLog_Severity `protobuf:"varint,5,opt,name=severity,proto3,enum=devsecdb.store.AuditLog_Severity" json:"severity,omitempty"`
	// Marshalled request.
...
var file_store_audit_log_proto_goTypes = []any{
	(AuditLog_Severity)(0),  // 0: devsecdb.store.AuditLog.Severity
	(*AuditLog)(nil),        // 1: devsecdb.store.AuditLog
	(*RequestMetadata)(nil), // 2: devsecdb.store.RequestMetadata
	(*status.Status)(nil),   // 3: google.rpc.Status
	(*anypb.Any)(nil),       // 4: google.protobuf.Any
}
var file_store_audit_log_proto_depIdxs = []int32{
	0, // 0: devsecdb.store.AuditLog.severity:type_name -> devsecdb.store.AuditLog.Severity
	3, // 1: devsecdb.store.AuditLog.status:type_name -> google.rpc.Status
	4, // 2: devsecdb.store.AuditLog.service_data:type_name -> google.protobuf.Any
	2, // 3: devsecdb.store.AuditLog.request_metadata:type_name -> devsecdb.store.RequestMetadata
