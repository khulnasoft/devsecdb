...
type SheetPayload struct {
	...
	// The SQL dialect.
	Engine Engine `protobuf:"varint,3,opt,name=engine,proto3,enum=devsecdb.store.Engine" json:"engine,omitempty"`
...
var file_store_sheet_proto_goTypes = []any{
	(*SheetPayload)(nil),   // 0: devsecdb.store.SheetPayload
	(*SheetCommand)(nil),   // 1: devsecdb.store.SheetCommand
	(*DatabaseConfig)(nil), // 2: devsecdb.store.DatabaseConfig
	(Engine)(0),            // 3: devsecdb.store.Engine
}
var file_store_sheet_proto_depIdxs = []int32{
	2, // 0: devsecdb.store.SheetPayload.database_config:type_name -> devsecdb.store.DatabaseConfig
	2, // 1: devsecdb.store.SheetPayload.baseline_database_config:type_name -> devsecdb.store.DatabaseConfig
	3, // 2: devsecdb.store.SheetPayload.engine:type_name -> devsecdb.store.Engine
	1, // 3: devsecdb.store.SheetPayload.commands:type_name -> devsecdb.store.SheetCommand
