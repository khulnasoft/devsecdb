...
type ReleasePayload_File struct {
	...
	Type        ReleaseFileType `protobuf:"varint,5,opt,name=type,proto3,enum=devsecdb.store.ReleaseFileType" json:"type,omitempty"`
...
var file_store_release_proto_goTypes = []any{
	(ReleaseFileType)(0),             // 0: devsecdb.store.ReleaseFileType
	(*ReleasePayload)(nil),           // 1: devsecdb.store.ReleasePayload
	(*ReleasePayload_File)(nil),      // 2: devsecdb.store.ReleasePayload.File
	(*ReleasePayload_VCSSource)(nil), // 3: devsecdb.store.ReleasePayload.VCSSource
	(VCSType)(0),                     // 4: devsecdb.store.VCSType
}
var file_store_release_proto_depIdxs = []int32{
	2, // 0: devsecdb.store.ReleasePayload.files:type_name -> devsecdb.store.ReleasePayload.File
	3, // 1: devsecdb.store.ReleasePayload.vcs_source:type_name -> devsecdb.store.ReleasePayload.VCSSource
	0, // 2: devsecdb.store.ReleasePayload.File.type:type_name -> devsecdb.store.ReleaseFileType
	4, // 3: devsecdb.store.ReleasePayload.VCSSource.vcs_type:type_name -> devsecdb.store.VCSType
