...
type IssuePayloadApproval struct {
	...
	RiskLevel            IssuePayloadApproval_RiskLevel `protobuf:"varint,5,opt,name=risk_level,json=riskLevel,proto3,enum=devsecdb.store.IssuePayloadApproval_RiskLevel" json:"risk_level,omitempty"`
}
...
type ApprovalStep struct {
	...
	Type  ApprovalStep_Type `protobuf:"varint,1,opt,name=type,proto3,enum=devsecdb.store.ApprovalStep_Type" json:"type,omitempty"`
...
type ApprovalNode struct {
	...
	Type ApprovalNode_Type `protobuf:"varint,1,opt,name=type,proto3,enum=devsecdb.store.ApprovalNode_Type" json:"type,omitempty"`
...
type ApprovalNode_GroupValue_ struct {
	GroupValue ApprovalNode_GroupValue `protobuf:"varint,2,opt,name=group_value,json=groupValue,proto3,enum=devsecdb.store.ApprovalNode_GroupValue,oneof"`
}
...
type IssuePayloadApproval_Approver struct {
	...
	// The new status.
	Status IssuePayloadApproval_Approver_Status `protobuf:"varint,1,opt,name=status,proto3,enum=devsecdb.store.IssuePayloadApproval_Approver_Status" json:"status,omitempty"`
...
var file_store_approval_proto_rawDesc = []byte{
	...
	0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x22, 0x80, 0x05, 0x0a, 0x14, 0x49, 0x73, 0x73, 0x75, 0x65,
	...
	0x6e, 0x67, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x4d, 0x0a, 0x0a, 0x72, 0x69, 0x73, 0x6b, 0x5f,
	0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2e, 0x2e, 0x62, 0x79,
	...
	,
	...
	,
	...
	,
	...
	0x79, 0x70, 0x65, 0x12, 0x32, 0x0a, 0x05, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x62, 0x79, 0x74, 0x65, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x73, 0x74,
	0x6f, 0x72, 0x65, 0x2e, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x61, 0x6c, 0x4e, 0x6f, 0x64, 0x65,
	...
	0x0a, 0x03, 0x41, 0x4e, 0x59, 0x10, 0x02, 0x22, 0x89, 0x03, 0x0a, 0x0c, 0x41, 0x70, 0x70, 0x72,
	0x6f, 0x76, 0x61, 0x6c, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x35, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65,
	...
	,
	...
	,
...
var file_store_approval_proto_goTypes = []any{
	(IssuePayloadApproval_RiskLevel)(0),       // 0: devsecdb.store.IssuePayloadApproval.RiskLevel
	(IssuePayloadApproval_Approver_Status)(0), // 1: devsecdb.store.IssuePayloadApproval.Approver.Status
	(ApprovalStep_Type)(0),                    // 2: devsecdb.store.ApprovalStep.Type
	(ApprovalNode_Type)(0),                    // 3: devsecdb.store.ApprovalNode.Type
	(ApprovalNode_GroupValue)(0),              // 4: devsecdb.store.ApprovalNode.GroupValue
	(*IssuePayloadApproval)(nil),              // 5: devsecdb.store.IssuePayloadApproval
	(*ApprovalTemplate)(nil),                  // 6: devsecdb.store.ApprovalTemplate
	(*ApprovalFlow)(nil),                      // 7: devsecdb.store.ApprovalFlow
	(*ApprovalStep)(nil),                      // 8: devsecdb.store.ApprovalStep
	(*ApprovalNode)(nil),                      // 9: devsecdb.store.ApprovalNode
	(*IssuePayloadApproval_Approver)(nil),     // 10: devsecdb.store.IssuePayloadApproval.Approver
}
var file_store_approval_proto_depIdxs = []int32{
	6,  // 0: devsecdb.store.IssuePayloadApproval.approval_templates:type_name -> devsecdb.store.ApprovalTemplate
	10, // 1: devsecdb.store.IssuePayloadApproval.approvers:type_name -> devsecdb.store.IssuePayloadApproval.Approver
	0,  // 2: devsecdb.store.IssuePayloadApproval.risk_level:type_name -> devsecdb.store.IssuePayloadApproval.RiskLevel
	7,  // 3: devsecdb.store.ApprovalTemplate.flow:type_name -> devsecdb.store.ApprovalFlow
	8,  // 4: devsecdb.store.ApprovalFlow.steps:type_name -> devsecdb.store.ApprovalStep
	2,  // 5: devsecdb.store.ApprovalStep.type:type_name -> devsecdb.store.ApprovalStep.Type
	9,  // 6: devsecdb.store.ApprovalStep.nodes:type_name -> devsecdb.store.ApprovalNode
	3,  // 7: devsecdb.store.ApprovalNode.type:type_name -> devsecdb.store.ApprovalNode.Type
	4,  // 8: devsecdb.store.ApprovalNode.group_value:type_name -> devsecdb.store.ApprovalNode.GroupValue
	1,  // 9: devsecdb.store.IssuePayloadApproval.Approver.status:type_name -> devsecdb.store.IssuePayloadApproval.Approver.Status
