...
type ExportArchivePayload struct {
	...
	FileFormat ExportFormat `protobuf:"varint,1,opt,name=file_format,json=fileFormat,proto3,enum=devsecdb.store.ExportFormat" json:"file_format,omitempty"`
}
...
var file_store_export_archive_proto_goTypes = []any{
	(*ExportArchivePayload)(nil), // 0: devsecdb.store.ExportArchivePayload
	(ExportFormat)(0),            // 1: devsecdb.store.ExportFormat
}
var file_store_export_archive_proto_depIdxs = []int32{
	1, // 0: devsecdb.store.ExportArchivePayload.file_format:type_name -> devsecdb.store.ExportFormat
