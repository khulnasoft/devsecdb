...
type TaskDatabaseDataExportPayload struct {
	...
	Format   ExportFormat `protobuf:"varint,4,opt,name=format,proto3,enum=devsecdb.store.ExportFormat" json:"format,omitempty"`
}
...
var file_store_task_proto_goTypes = []any{
	(*TaskDatabaseCreatePayload)(nil),     // 0: devsecdb.store.TaskDatabaseCreatePayload
	(*TaskDatabaseUpdatePayload)(nil),     // 1: devsecdb.store.TaskDatabaseUpdatePayload
	(*TaskDatabaseDataExportPayload)(nil), // 2: devsecdb.store.TaskDatabaseDataExportPayload
	(*TaskReleaseSource)(nil),             // 3: devsecdb.store.TaskReleaseSource
	nil,                                   // 4: devsecdb.store.TaskDatabaseUpdatePayload.FlagsEntry
	(*PreUpdateBackupDetail)(nil),         // 5: devsecdb.store.PreUpdateBackupDetail
	(ExportFormat)(0),                     // 6: devsecdb.store.ExportFormat
}
var file_store_task_proto_depIdxs = []int32{
	5, // 0: devsecdb.store.TaskDatabaseUpdatePayload.pre_update_backup_detail:type_name -> devsecdb.store.PreUpdateBackupDetail
	4, // 1: devsecdb.store.TaskDatabaseUpdatePayload.flags:type_name -> devsecdb.store.TaskDatabaseUpdatePayload.FlagsEntry
	3, // 2: devsecdb.store.TaskDatabaseUpdatePayload.task_release_source:type_name -> devsecdb.store.TaskReleaseSource
	6, // 3: devsecdb.store.TaskDatabaseDataExportPayload.format:type_name -> devsecdb.store.ExportFormat
