...
var file_store_database_proto_goTypes = []any{
	...
	(*EventMetadata)(nil),            // 8: devsecdb.store.EventMetadata
	(*SequenceMetadata)(nil),         // 9: devsecdb.store.SequenceMetadata
	(*TriggerMetadata)(nil),          // 10: devsecdb.store.TriggerMetadata
	(*TaskMetadata)(nil),             // 11: devsecdb.store.TaskMetadata
	(*StreamMetadata)(nil),           // 12: devsecdb.store.StreamMetadata
	(*TableMetadata)(nil),            // 13: devsecdb.store.TableMetadata
	(*CheckConstraintMetadata)(nil),  // 14: devsecdb.store.CheckConstraintMetadata
	(*ExternalTableMetadata)(nil),    // 15: devsecdb.store.ExternalTableMetadata
	(*TablePartitionMetadata)(nil),   // 16: devsecdb.store.TablePartitionMetadata
	(*ColumnMetadata)(nil),           // 17: devsecdb.store.ColumnMetadata
	(*GenerationMetadata)(nil),       // 18: devsecdb.store.GenerationMetadata
	(*ViewMetadata)(nil),             // 19: devsecdb.store.ViewMetadata
	(*DependentColumn)(nil),          // 20: devsecdb.store.DependentColumn
	(*MaterializedViewMetadata)(nil), // 21: devsecdb.store.MaterializedViewMetadata
	(*FunctionMetadata)(nil),         // 22: devsecdb.store.FunctionMetadata
	(*ProcedureMetadata)(nil),        // 23: devsecdb.store.ProcedureMetadata
	(*PackageMetadata)(nil),          // 24: devsecdb.store.PackageMetadata
	(*IndexMetadata)(nil),            // 25: devsecdb.store.IndexMetadata
	(*ExtensionMetadata)(nil),        // 26: devsecdb.store.ExtensionMetadata
	(*ForeignKeyMetadata)(nil),       // 27: devsecdb.store.ForeignKeyMetadata
	(*InstanceRoleMetadata)(nil),     // 28: devsecdb.store.InstanceRoleMetadata
	(*Secrets)(nil),                  // 29: devsecdb.store.Secrets
	(*SecretItem)(nil),               // 30: devsecdb.store.SecretItem
	(*DatabaseConfig)(nil),           // 31: devsecdb.store.DatabaseConfig
	(*SchemaConfig)(nil),             // 32: devsecdb.store.SchemaConfig
	(*TableConfig)(nil),              // 33: devsecdb.store.TableConfig
	(*FunctionConfig)(nil),           // 34: devsecdb.store.FunctionConfig
	(*ProcedureConfig)(nil),          // 35: devsecdb.store.ProcedureConfig
	(*ViewConfig)(nil),               // 36: devsecdb.store.ViewConfig
	(*ColumnConfig)(nil),             // 37: devsecdb.store.ColumnConfig
	(*LinkedDatabaseMetadata)(nil),   // 38: devsecdb.store.LinkedDatabaseMetadata
	nil,                              // 39: devsecdb.store.DatabaseMetadata.LabelsEntry
	nil,                              // 40: devsecdb.store.ColumnConfig.LabelsEntry
	(*timestamppb.Timestamp)(nil),    // 41: google.protobuf.Timestamp
	(*wrapperspb.StringValue)(nil),   // 42: google.protobuf.StringValue
}
var file_store_database_proto_depIdxs = []int32{
	39, // 0: devsecdb.store.DatabaseMetadata.labels:type_name -> devsecdb.store.DatabaseMetadata.LabelsEntry
	41, // 1: devsecdb.store.DatabaseMetadata.last_sync_time:type_name -> google.protobuf.Timestamp
	7,  // 2: devsecdb.store.DatabaseSchemaMetadata.schemas:type_name -> devsecdb.store.SchemaMetadata
	26, // 3: devsecdb.store.DatabaseSchemaMetadata.extensions:type_name -> devsecdb.store.ExtensionMetadata
	38, // 4: devsecdb.store.DatabaseSchemaMetadata.linked_databases:type_name -> devsecdb.store.LinkedDatabaseMetadata
	13, // 5: devsecdb.store.SchemaMetadata.tables:type_name -> devsecdb.store.TableMetadata
	15, // 6: devsecdb.store.SchemaMetadata.external_tables:type_name -> devsecdb.store.ExternalTableMetadata
	19, // 7: devsecdb.store.SchemaMetadata.views:type_name -> devsecdb.store.ViewMetadata
	22, // 8: devsecdb.store.SchemaMetadata.functions:type_name -> devsecdb.store.FunctionMetadata
	23, // 9: devsecdb.store.SchemaMetadata.procedures:type_name -> devsecdb.store.ProcedureMetadata
	12, // 10: devsecdb.store.SchemaMetadata.streams:type_name -> devsecdb.store.StreamMetadata
	11, // 11: devsecdb.store.SchemaMetadata.tasks:type_name -> devsecdb.store.TaskMetadata
	21, // 12: devsecdb.store.SchemaMetadata.materialized_views:type_name -> devsecdb.store.MaterializedViewMetadata
	9,  // 13: devsecdb.store.SchemaMetadata.sequences:type_name -> devsecdb.store.SequenceMetadata
	24, // 14: devsecdb.store.SchemaMetadata.packages:type_name -> devsecdb.store.PackageMetadata
	10, // 15: devsecdb.store.SchemaMetadata.triggers:type_name -> devsecdb.store.TriggerMetadata
	8,  // 16: devsecdb.store.SchemaMetadata.events:type_name -> devsecdb.store.EventMetadata
	0,  // 17: devsecdb.store.TaskMetadata.state:type_name -> devsecdb.store.TaskMetadata.State
	1,  // 18: devsecdb.store.StreamMetadata.type:type_name -> devsecdb.store.StreamMetadata.Type
	2,  // 19: devsecdb.store.StreamMetadata.mode:type_name -> devsecdb.store.StreamMetadata.Mode
	17, // 20: devsecdb.store.TableMetadata.columns:type_name -> devsecdb.store.ColumnMetadata
	25, // 21: devsecdb.store.TableMetadata.indexes:type_name -> devsecdb.store.IndexMetadata
	27, // 22: devsecdb.store.TableMetadata.foreign_keys:type_name -> devsecdb.store.ForeignKeyMetadata
	16, // 23: devsecdb.store.TableMetadata.partitions:type_name -> devsecdb.store.TablePartitionMetadata
	14, // 24: devsecdb.store.TableMetadata.check_constraints:type_name -> devsecdb.store.CheckConstraintMetadata
	17, // 25: devsecdb.store.ExternalTableMetadata.columns:type_name -> devsecdb.store.ColumnMetadata
	3,  // 26: devsecdb.store.TablePartitionMetadata.type:type_name -> devsecdb.store.TablePartitionMetadata.Type
	16, // 27: devsecdb.store.TablePartitionMetadata.subpartitions:type_name -> devsecdb.store.TablePartitionMetadata
	42, // 28: devsecdb.store.ColumnMetadata.default:type_name -> google.protobuf.StringValue
	18, // 29: devsecdb.store.ColumnMetadata.generation:type_name -> devsecdb.store.GenerationMetadata
	4,  // 30: devsecdb.store.GenerationMetadata.type:type_name -> devsecdb.store.GenerationMetadata.Type
	20, // 31: devsecdb.store.ViewMetadata.dependent_columns:type_name -> devsecdb.store.DependentColumn
	17, // 32: devsecdb.store.ViewMetadata.columns:type_name -> devsecdb.store.ColumnMetadata
	20, // 33: devsecdb.store.MaterializedViewMetadata.dependent_columns:type_name -> devsecdb.store.DependentColumn
	30, // 34: devsecdb.store.Secrets.items:type_name -> devsecdb.store.SecretItem
	32, // 35: devsecdb.store.DatabaseConfig.schema_configs:type_name -> devsecdb.store.SchemaConfig
	33, // 36: devsecdb.store.SchemaConfig.table_configs:type_name -> devsecdb.store.TableConfig
	34, // 37: devsecdb.store.SchemaConfig.function_configs:type_name -> devsecdb.store.FunctionConfig
	35, // 38: devsecdb.store.SchemaConfig.procedure_configs:type_name -> devsecdb.store.ProcedureConfig
	36, // 39: devsecdb.store.SchemaConfig.view_configs:type_name -> devsecdb.store.ViewConfig
	37, // 40: devsecdb.store.TableConfig.column_configs:type_name -> devsecdb.store.ColumnConfig
	41, // 41: devsecdb.store.TableConfig.update_time:type_name -> google.protobuf.Timestamp
	41, // 42: devsecdb.store.FunctionConfig.update_time:type_name -> google.protobuf.Timestamp
	41, // 43: devsecdb.store.ProcedureConfig.update_time:type_name -> google.protobuf.Timestamp
	41, // 44: devsecdb.store.ViewConfig.update_time:type_name -> google.protobuf.Timestamp
	40, // 45: devsecdb.store.ColumnConfig.labels:type_name -> devsecdb.store.ColumnConfig.LabelsEntry
