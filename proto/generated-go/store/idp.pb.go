...
type OAuth2IdentityProviderConfig struct {
	...
	AuthStyle     OAuth2AuthStyle `protobuf:"varint,9,opt,name=auth_style,json=authStyle,proto3,enum=devsecdb.store.OAuth2AuthStyle" json:"auth_style,omitempty"`
}
...
type OIDCIdentityProviderConfig struct {
	...
	AuthStyle     OAuth2AuthStyle `protobuf:"varint,6,opt,name=auth_style,json=authStyle,proto3,enum=devsecdb.store.OAuth2AuthStyle" json:"auth_style,omitempty"`
}
...
var file_store_idp_proto_goTypes = []any{
	(IdentityProviderType)(0),            // 0: devsecdb.store.IdentityProviderType
	(OAuth2AuthStyle)(0),                 // 1: devsecdb.store.OAuth2AuthStyle
	(*IdentityProviderConfig)(nil),       // 2: devsecdb.store.IdentityProviderConfig
	(*OAuth2IdentityProviderConfig)(nil), // 3: devsecdb.store.OAuth2IdentityProviderConfig
	(*OIDCIdentityProviderConfig)(nil),   // 4: devsecdb.store.OIDCIdentityProviderConfig
	(*LDAPIdentityProviderConfig)(nil),   // 5: devsecdb.store.LDAPIdentityProviderConfig
	(*FieldMapping)(nil),                 // 6: devsecdb.store.FieldMapping
	(*IdentityProviderUserInfo)(nil),     // 7: devsecdb.store.IdentityProviderUserInfo
}
var file_store_idp_proto_depIdxs = []int32{
	3, // 0: devsecdb.store.IdentityProviderConfig.oauth2_config:type_name -> devsecdb.store.OAuth2IdentityProviderConfig
	4, // 1: devsecdb.store.IdentityProviderConfig.oidc_config:type_name -> devsecdb.store.OIDCIdentityProviderConfig
	5, // 2: devsecdb.store.IdentityProviderConfig.ldap_config:type_name -> devsecdb.store.LDAPIdentityProviderConfig
	6, // 3: devsecdb.store.OAuth2IdentityProviderConfig.field_mapping:type_name -> devsecdb.store.FieldMapping
	1, // 4: devsecdb.store.OAuth2IdentityProviderConfig.auth_style:type_name -> devsecdb.store.OAuth2AuthStyle
	6, // 5: devsecdb.store.OIDCIdentityProviderConfig.field_mapping:type_name -> devsecdb.store.FieldMapping
	1, // 6: devsecdb.store.OIDCIdentityProviderConfig.auth_style:type_name -> devsecdb.store.OAuth2AuthStyle
	6, // 7: devsecdb.store.LDAPIdentityProviderConfig.field_mapping:type_name -> devsecdb.store.FieldMapping
