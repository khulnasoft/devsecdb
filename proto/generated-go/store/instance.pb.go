...
var file_store_instance_proto_goTypes = []any{
	(*InstanceOptions)(nil),       // 0: devsecdb.store.InstanceOptions
	(*InstanceMetadata)(nil),      // 1: devsecdb.store.InstanceMetadata
	(*InstanceRole)(nil),          // 2: devsecdb.store.InstanceRole
	(*durationpb.Duration)(nil),   // 3: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_store_instance_proto_depIdxs = []int32{
	3, // 0: devsecdb.store.InstanceOptions.sync_interval:type_name -> google.protobuf.Duration
	4, // 1: devsecdb.store.InstanceMetadata.last_sync_time:type_name -> google.protobuf.Timestamp
	2, // 2: devsecdb.store.InstanceMetadata.roles:type_name -> devsecdb.store.InstanceRole
