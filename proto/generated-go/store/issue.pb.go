...
var file_store_issue_proto_goTypes = []any{
	(*IssuePayload)(nil),         // 0: devsecdb.store.IssuePayload
	(*GrantRequest)(nil),         // 1: devsecdb.store.GrantRequest
	(*IssuePayloadApproval)(nil), // 2: devsecdb.store.IssuePayloadApproval
	(*expr.Expr)(nil),            // 3: google.type.Expr
	(*durationpb.Duration)(nil),  // 4: google.protobuf.Duration
}
var file_store_issue_proto_depIdxs = []int32{
	2, // 0: devsecdb.store.IssuePayload.approval:type_name -> devsecdb.store.IssuePayloadApproval
	1, // 1: devsecdb.store.IssuePayload.grant_request:type_name -> devsecdb.store.GrantRequest
	3, // 2: devsecdb.store.GrantRequest.condition:type_name -> google.type.Expr
	4, // 3: devsecdb.store.GrantRequest.expiration:type_name -> google.protobuf.Duration
