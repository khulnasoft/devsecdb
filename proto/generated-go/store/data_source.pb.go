...
type DataSourceExternalSecret struct {
	...
	SecretType DataSourceExternalSecret_SecretType `protobuf:"varint,1,opt,name=secret_type,json=secretType,proto3,enum=devsecdb.store.DataSourceExternalSecret_SecretType" json:"secret_type,omitempty"`
	Url        string                              `protobuf:"bytes,2,opt,name=url,proto3" json:"url,omitempty"`
	AuthType   DataSourceExternalSecret_AuthType   `protobuf:"varint,3,opt,name=auth_type,json=authType,proto3,enum=devsecdb.store.DataSourceExternalSecret_AuthType" json:"auth_type,omitempty"`
...
type DataSourceOptions struct {
	...
	AuthenticationType                 DataSourceOptions_AuthenticationType `protobuf:"varint,12,opt,name=authentication_type,json=authenticationType,proto3,enum=devsecdb.store.DataSourceOptions_AuthenticationType" json:"authentication_type,omitempty"`
	...
	RedisType                DataSourceOptions_RedisType `protobuf:"varint,23,opt,name=redis_type,json=redisType,proto3,enum=devsecdb.store.DataSourceOptions_RedisType" json:"redis_type,omitempty"`
...
type DataSourceExternalSecret_AppRoleAuthOption struct {
	...
	Type     DataSourceExternalSecret_AppRoleAuthOption_SecretType `protobuf:"varint,3,opt,name=type,proto3,enum=devsecdb.store.DataSourceExternalSecret_AppRoleAuthOption_SecretType" json:"type,omitempty"`
...
var file_store_data_source_proto_goTypes = []any{
	(DataSourceExternalSecret_SecretType)(0),                   // 0: devsecdb.store.DataSourceExternalSecret.SecretType
	(DataSourceExternalSecret_AuthType)(0),                     // 1: devsecdb.store.DataSourceExternalSecret.AuthType
	(DataSourceExternalSecret_AppRoleAuthOption_SecretType)(0), // 2: devsecdb.store.DataSourceExternalSecret.AppRoleAuthOption.SecretType
	(DataSourceOptions_AuthenticationType)(0),                  // 3: devsecdb.store.DataSourceOptions.AuthenticationType
	(DataSourceOptions_RedisType)(0),                           // 4: devsecdb.store.DataSourceOptions.RedisType
	(*DataSourceExternalSecret)(nil),                           // 5: devsecdb.store.DataSourceExternalSecret
	(*DataSourceOptions)(nil),                                  // 6: devsecdb.store.DataSourceOptions
	(*SASLConfig)(nil),                                         // 7: devsecdb.store.SASLConfig
	(*KerberosConfig)(nil),                                     // 8: devsecdb.store.KerberosConfig
	(*DataSourceExternalSecret_AppRoleAuthOption)(nil),         // 9: devsecdb.store.DataSourceExternalSecret.AppRoleAuthOption
	(*DataSourceOptions_Address)(nil),                          // 10: devsecdb.store.DataSourceOptions.Address
}
var file_store_data_source_proto_depIdxs = []int32{
	0,  // 0: devsecdb.store.DataSourceExternalSecret.secret_type:type_name -> devsecdb.store.DataSourceExternalSecret.SecretType
	1,  // 1: devsecdb.store.DataSourceExternalSecret.auth_type:type_name -> devsecdb.store.DataSourceExternalSecret.AuthType
	9,  // 2: devsecdb.store.DataSourceExternalSecret.app_role:type_name -> devsecdb.store.DataSourceExternalSecret.AppRoleAuthOption
	5,  // 3: devsecdb.store.DataSourceOptions.external_secret:type_name -> devsecdb.store.DataSourceExternalSecret
	3,  // 4: devsecdb.store.DataSourceOptions.authentication_type:type_name -> devsecdb.store.DataSourceOptions.AuthenticationType
	7,  // 5: devsecdb.store.DataSourceOptions.sasl_config:type_name -> devsecdb.store.SASLConfig
	10, // 6: devsecdb.store.DataSourceOptions.additional_addresses:type_name -> devsecdb.store.DataSourceOptions.Address
	4,  // 7: devsecdb.store.DataSourceOptions.redis_type:type_name -> devsecdb.store.DataSourceOptions.RedisType
	8,  // 8: devsecdb.store.SASLConfig.krb_config:type_name -> devsecdb.store.KerberosConfig
	2,  // 9: devsecdb.store.DataSourceExternalSecret.AppRoleAuthOption.type:type_name -> devsecdb.store.DataSourceExternalSecret.AppRoleAuthOption.SecretType
