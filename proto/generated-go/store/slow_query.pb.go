...
var file_store_slow_query_proto_goTypes = []any{
	(*SlowQueryStatistics)(nil),     // 0: devsecdb.store.SlowQueryStatistics
	(*SlowQueryStatisticsItem)(nil), // 1: devsecdb.store.SlowQueryStatisticsItem
	(*SlowQueryDetails)(nil),        // 2: devsecdb.store.SlowQueryDetails
	(*timestamppb.Timestamp)(nil),   // 3: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),     // 4: google.protobuf.Duration
}
var file_store_slow_query_proto_depIdxs = []int32{
	1, // 0: devsecdb.store.SlowQueryStatistics.items:type_name -> devsecdb.store.SlowQueryStatisticsItem
	3, // 1: devsecdb.store.SlowQueryStatisticsItem.latest_log_time:type_name -> google.protobuf.Timestamp
	4, // 2: devsecdb.store.SlowQueryStatisticsItem.total_query_time:type_name -> google.protobuf.Duration
	4, // 3: devsecdb.store.SlowQueryStatisticsItem.maximum_query_time:type_name -> google.protobuf.Duration
	2, // 4: devsecdb.store.SlowQueryStatisticsItem.samples:type_name -> devsecdb.store.SlowQueryDetails
	3, // 5: devsecdb.store.SlowQueryDetails.start_time:type_name -> google.protobuf.Timestamp
	4, // 6: devsecdb.store.SlowQueryDetails.query_time:type_name -> google.protobuf.Duration
	4, // 7: devsecdb.store.SlowQueryDetails.lock_time:type_name -> google.protobuf.Duration
