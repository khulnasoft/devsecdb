...
CREATE TABLE devsecdb_migration_history (
...
CREATE UNIQUE INDEX devsecdb_idx_unique_migration_history_namespace_sequence ON devsecdb_migration_history (namespace, sequence);

CREATE UNIQUE INDEX devsecdb_idx_unique_migration_history_namespace_version ON devsecdb_migration_history (namespace, version);

CREATE INDEX devsecdb_idx_migration_history_namespace_source_type ON devsecdb_migration_history(namespace, source, type);

CREATE INDEX devsecdb_idx_migration_history_namespace_created ON devsecdb_migration_history(namespace, created_ts);
