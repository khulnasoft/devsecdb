...
func (driver *Driver) Dump(ctx context.Context, out io.Writer) error {
	...
	// Learn more: https://linear.app/devsecdb/issue/BYT-5401/support-iam-authentication-for-gcp-and-aws
...
func buildPostgreSQLKeywordValueConnectionString(host, port, username, password, database string) string {
	...
	pairs["application_name"] = escapeConnectionStringValue("devsecdb dump")
