#!/bin/bash
# ===========================================================================
# File: devsecdb-sql-review.sh
# Description: usage: ./devsecdb-sql-review.sh --pull-request-id=[pr id] --repo-id=[repo id] --repo-url=[repo URL] --api=[API URL] --token=[API token]
# ===========================================================================
...
mkdir test-results
echo $msg >> test-results/devsecdb-sql-review.xml
