...
// Usage:
//  email := NewEmailMsg().SetFrom("Devsecdb <from@secdb.khulnasoft.com>").AddTo("Customer <to@secdb.khulnasoft.com>").SetSubject("Test Email Subject").SetBody(`
// <!DOCTYPE html>
// <html>
// <head>
...
// 	client.SetAuthCredentials("from@secdb.khulnasoft.com", "nqxxxxxxxxxxxxxx")
...
// Only accept the valid RFC 5322 address, e.g. "Devsecdb <support@secdb.khulnasoft.com>".
