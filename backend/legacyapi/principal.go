...
const SystemBotEmail = "support@secdb.khulnasoft.com"
...
const (
	...
	// EndUser represents the human being using Devsecdb.
	EndUser PrincipalType = "END_USER"
	// ServiceAccount is the principal type for SERVICE_ACCOUNT.
	// ServiceAcount represents the external service calling Devsecdb OpenAPI.
