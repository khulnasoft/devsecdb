				...
				SchemaConfigs: []*storepb.SchemaConfig{
					{
						...
						TableConfigs: []*storepb.TableConfig{
							{
								Name:         "t1",
								Updater:      "anonymous+01@secdb.khulnasoft.com",
								UpdateTime:   time1,
								SourceBranch: "feat/01",
							},
							{
								Name:         "t2",
								Updater:      "anonymous+02@secdb.khulnasoft.com",
								UpdateTime:   time2,
						...
						tables: map[string]*updateInfoDiffTableNode{
							"t1": {
								...
								updateInfo: &updateInfo{
									...
									lastUpdater:     "anonymous+01@secdb.khulnasoft.com",
									sourceBranch:    "feat/01",
								},
							},
							"t2": {
								...
								updateInfo: &updateInfo{
									...
									lastUpdater:     "anonymous+02@secdb.khulnasoft.com",
									sourceBranch:    "feat/02",
								},
							},
							"t3": {
