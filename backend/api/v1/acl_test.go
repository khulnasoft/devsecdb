...
func TestGetResourceFromRequest(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			method:  "/devsecdb.v1.AuthService/Login",
			want: []*common.Resource{
				{Workspace: true},
			},
		},
		{
			...
			method: "/devsecdb.v1.ProjectService/CreateProject",
			want: []*common.Resource{
				{Workspace: true},
			},
		},
		{
			...
			method: "/devsecdb.v1.ProjectService/UpdateProject",
			want: []*common.Resource{
				{Name: "projects/hello"},
			},
		},
		{
			...
			method:  "/devsecdb.v1.ProjectService/ListProjects",
			want: []*common.Resource{
				{Workspace: true},
			},
		},
		// The database group has not been annotated with resource yet.
		{
			...
			method: "/devsecdb.v1.DatabaseGroupService/CreateDatabaseGroup",
			want: []*common.Resource{
				{Name: "projects/hello"},
			},
		},
		{
			...
			method: "/devsecdb.v1.InstanceService/UpdateInstance",
			want: []*common.Resource{
				{Name: "instances/hello"},
			},
		},
		{
			...
			method: "/devsecdb.v1.SubscriptionService/UpdateSubscription",
			want: []*common.Resource{
				{Workspace: true},
			},
		},
		{
			...
			method: "/devsecdb.v1.ProjectService/RemoveWebhook",
			want: []*common.Resource{
				{Name: "projects/aaa/webhooks/bbb"},
			},
		},
		{
			...
			method: "/devsecdb.v1.IdentityProviderService/UpdateIdentityProvider",
			want: []*common.Resource{
				{Name: "idps/hello"},
			},
		},
		{
			...
			method: "/devsecdb.v1.IdentityProviderService/TestIdentityProvider",
			want: []*common.Resource{
				{Name: "idps/hello"},
			},
		},
		{
			...
			method:  "/devsecdb.v1.ReviewConfigService/ListReviewConfigs",
			want: []*common.Resource{
				{Workspace: true},
			},
		},
		{
			...
			method: "/devsecdb.v1.DatabaseService/BatchUpdateDatabases",
			want: []*common.Resource{
		...
		},
		{
			...
			method: "/devsecdb.v1.InstanceService/SyncInstance",
			want: []*common.Resource{
				{Name: "instances/hello"},
			},
		},
		{
			...
			method: "/devsecdb.v1.InstanceService/BatchSyncInstances",
			want: []*common.Resource{
				{Name: "instances/hello"},
				{Name: "instances/world"},
			},
		},
		{
			...
			method: "/devsecdb.v1.PlanService/BatchCancelPlanCheckRuns",
			want: []*common.Resource{
