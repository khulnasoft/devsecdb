// Package server implements the API server for Devsecdb.
package server
...
import (
	...
	directorysync "github.com/khulnasoft/devsecdb/backend/api/directory-sync"
	"github.com/khulnasoft/devsecdb/backend/api/gitops"
	"github.com/khulnasoft/devsecdb/backend/api/lsp"
	apiv1 "github.com/khulnasoft/devsecdb/backend/api/v1"
	"github.com/khulnasoft/devsecdb/backend/common/log"
	"github.com/khulnasoft/devsecdb/backend/common/stacktrace"
	...
	"github.com/khulnasoft/devsecdb/backend/component/webhook"
	"github.com/khulnasoft/devsecdb/backend/demo"
	enterprise "github.com/khulnasoft/devsecdb/backend/enterprise/api"
	enterprisesvc "github.com/khulnasoft/devsecdb/backend/enterprise/service"
	api "github.com/khulnasoft/devsecdb/backend/legacyapi"
	"github.com/khulnasoft/devsecdb/backend/migrator"
	dbdriver "github.com/khulnasoft/devsecdb/backend/plugin/db"
	"github.com/khulnasoft/devsecdb/backend/resources/mongoutil"
	"github.com/khulnasoft/devsecdb/backend/resources/mysqlutil"
	"github.com/khulnasoft/devsecdb/backend/resources/postgres"
	"github.com/khulnasoft/devsecdb/backend/runner/approval"
	"github.com/khulnasoft/devsecdb/backend/runner/mail"
	"github.com/khulnasoft/devsecdb/backend/runner/metricreport"
	"github.com/khulnasoft/devsecdb/backend/runner/plancheck"
	"github.com/khulnasoft/devsecdb/backend/runner/relay"
	"github.com/khulnasoft/devsecdb/backend/runner/schemasync"
	"github.com/khulnasoft/devsecdb/backend/runner/slowquerysync"
	"github.com/khulnasoft/devsecdb/backend/runner/taskrun"
	"github.com/khulnasoft/devsecdb/backend/store"
)

const (
	// webhookAPIPrefix is the API prefix for Devsecdb webhook.
	webhookAPIPrefix = "/hook"
	scimAPIPrefix    = "/scim"
	// lspAPI is the API for Devsecdb Language Server Protocol.
	lspAPI                 = "/lsp"
	maxStacksize           = 1024 * 10240
	gracefulShutdownPeriod = 10 * time.Second
)

// Server is the Devsecdb server.
type Server struct {
...
func NewServer(ctx context.Context, profile *config.Profile) (*Server, error) {
	...
	// to store Devsecdb's own metadata.
	...
	// Connect to the instance that stores devsecdb's own metadata.
