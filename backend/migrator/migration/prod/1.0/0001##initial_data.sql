...
-- Both instances contains the connection info we expect user to setup according to https://www.secdb.khulnasoft.com/docs/tutorials/local-mysql-instance
-- Set host to 172.17.0.1 which is the default docker gateway ip.
-- Our quickstart guide suggests to run both Devsecdb and MySQL using docker, and in such case, devsecdb access the mysqld container via 172.17.0.1
-- "test" instance
INSERT INTO
    instance (
        id,
...
VALUES
    (
        ...
        '3306',
        'https://www.secdb.khulnasoft.com/docs/tutorials/local-mysql-instance'
    );
