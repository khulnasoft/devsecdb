...
-- Default devsecdb system account id is 1
INSERT INTO
    principal (
        id,
        creator_id,
...
CREATE TABLE project (
    ...
    role_provider TEXT NOT NULL CHECK (role_provider IN ('DEVSECDB', 'GITLAB_SELF_HOST')) DEFAULT 'DEVSECDB'
);
...
CREATE TABLE repository (
    ...
    -- The file path template for storing the latest schema auto-generated by Devsecdb after migration.
    -- If empty, then Devsecdb won't auto generate it.
    ...
    -- Identify the host of the webhook url where the webhook event sends. We store this to identify stale webhook url whose url doesn't match the current devsecdb --external-url.
